...
$query = "SELECT id1, customerCode, fullname, Mobile_Phone, dateCreated, EmailAddress, Status
          FROM buyersinformationsheet
          WHERE Status = 'Appointment' OR Status = 'APPOINTMENT'";
...
if ($stmt->execute()) {
    ...
    $stmt->bind_result($id, $customerCode, $fullname,  $r_Address, $dateCreated, $EmailAddress, $status);
