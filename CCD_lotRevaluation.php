                                    ...
                                    <div  style="width: 50%; float: left;">
                                        <table class="table"   cellspacing="0" >
                                           ...
                                           <p style="padding-top: 5px;"> Terms :</p>
                                            ...
                                            <td style="border: none;background-color: transparent;color:#4a4949;padding-left:15px;padding-right:15px;padding-bottom:0px;margin:0px; font-weight: bold;" >
                                            <select  type="text"  class="form-control" style="padding: 8px;   font-size: 13px;" id="terms" name="terms">
                                                    <option > --- SELECT TERMS ---</option> 
                                                    <option  name="Installment" value="Installment"> Installment</option> 
                                                    <option name="Spotcash" value="Spotcash"> Spotcash</option> 
                                                    <option name="Thirtydayscash" value="Thirtydayscash"> 30 days cash</option> 
                                                    </select>
                                            </td>
                                            </tr>
                                            ...
                                            <td style="border: none;background-color: transparent;color:#4a4949;padding-left:15px;padding-right:15px;padding-bottom:0px;padding-top:0px;margin:0px; font-weight: bold;" >
                                              <select  type="text"  class="form-control" style="padding: 8px;   font-size: 13px;" id="modeOfpayment" name="modeOfpayment">
                                        ...
                                        <table class="table"   cellspacing="0"   >
                                           ...
                                           <td style="border: none;background-color: #5B7EDE;font-size: 13px;color:white;padding:0px 15px;margin:0px; font-weight: bold;" >
                                            Total Contract Price :
                                             ...
                                             <td style="border: none;background-color: #5B7EDE;color:#4a4949;padding:0px 15px;margin:0px;" >
                                            <input placeholder="₱ 0.00" pattern="^\₱\d{1,3}(,\d{3})*(\.\d+)?₱" data-type="currency" oninput="computedp()" style="padding:0px 15px; width: 92%; font-size: 13px; margin:0px; background-color: #FDFDFD ;border: none;color:#4a4949" id ="totalContractPrice3" name ="totalContractPrice3"></input>
                                            </td>
                                            </tr>
                                            <tr style="border: none">
                                           <td style="border: none;background-color: #5B7EDE;font-size: 13px;color:white;padding:0px 15px;margin:0px; font-weight: bold;" >
                                           ...
                                           <td style="border: none;background-color: #5B7EDE;font-size: 13px;color:white;padding:0px 15px;margin:0px; font-weight: bold;" >
                                            Downpayment : <input  placeholder="0.00" oninput="computedp()" pattern="^\%\d{1,3}(,\d{3})*(\.\d+)?%"    type="number" style="float: right; padding:0px 5px; font-size: 13px; margin:0px; background-color: #e8e4c9 ;border: none;color:#4a4949;width: 25%"  id="dpPercentage" name="dpPercentage"   ></input> <a style= "float: right; font-size: 13px; margin-right:5px; border: none;color:#fffff;width: 5%">% </a>
                                             ...
                                             <td style="border: none;background-color: #5B7EDE;color:#4a4949;padding:0px 15px;margin:0px;" >
                                            <input  placeholder="₱ 0.00" pattern="^\₱\d{1,3}(,\d{3})*(\.\d+)?₱" oninput="computedppercentage()" data-type="currency" style="padding:0px 15px; width: 92%; font-size: 13px; margin:0px; background-color: #FDFDFD ;border: none;color:#4a4949" id="dpPercentage2" name="dpPercentage2" ></input>
                                            </td>
                                            </tr>
                                            <tr style="border: none">
                                           <td style="border: none;background-color: #5B7EDE;font-size: 13px;color:white;padding:0px 15px;margin:0px; font-weight: bold;" >
                                           ...
                                           <td style="border: none;background-color: #5B7EDE;font-size: 13px;color:white;padding:0px 15px;margin:0px; font-weight: bold;" >
                                            ...
                                            <input placeholder="₱ 0.00" id="MI" name="MI" readonly  pattern="^\₱\d{1,3}(,\d{3})*(\.\d+)?₱" data-type="currency"  style="padding:0px 15px; width: 92%; font-size: 13px; margin:0px; background-color: #e8e4c9 ;border: none;color:#4a4949" ></input>
                                            <input placeholder="₱ 0.00" hidden id="MIInterestPercentage" value="50" name="MIInterestPercentage" readonly  pattern="^\₱\d{1,3}(,\d{3})*(\.\d+)?₱" data-type="currency"  style="padding:0px 15px; width: 92%; font-size: 13px; margin:0px; background-color: #e8e4c9 ;border: none;color:#4a4949" ></input>
                                            <input placeholder="₱ 0.00" hidden id="MIPrincipalPercentage" value="50" name="MIPrincipalPercentage" readonly  pattern="^\₱\d{1,3}(,\d{3})*(\.\d+)?₱" data-type="currency"  style="padding:0px 15px; width: 92%; font-size: 13px; margin:0px; background-color: #e8e4c9 ;border: none;color:#4a4949" ></input>
...
<div class="modal fade bd-example-modal-vat" tabindex="-1" role="dialog" id="Markup" aria-labelledby="myLargeModalLabel" aria-hidden="true" style=" margin: auto; bottom: 0px; left: 0px; right:0px; width: 98%; color:#2F4F4F">
  <div class="modal-dialog" role="document">
    ...
    <script>
        ...
        let pcf =  document.getElementById("pcf").value;
        let replacedpcf = pcf.replace(/\B(?=(\d{3})+(?!\d))/g, ",");
        document.getElementById("pcf").value = replacedpcf;
        ...
        let replacedamountdp1Fixed = amountdp1Fixed.replace(/\B(?=(\d{3})+(?!\d))/g, ",");
        document.getElementById("dpPercentage2").value =  "₱ " + replacedamountdp1Fixed;
        ...
        let replacedbalance1Fixed = balance1Fixed.replace(/\B(?=(\d{3})+(?!\d))/g, ",");
        document.getElementById("balance").value = "₱ " + replacedbalance1Fixed;
        document.getElementById("balance1").value = replacedbalance1Fixed;
        ...
        replacedlotlistPriceTD = lotlistPriceTD.replace(/\B(?=(\d{3})+(?!\d))/g, ",");
        document.getElementById("lotListPrice").value =  "₱ " + replacedlotlistPriceTD;
        ...
        const replacedsubtotaltaxfixed = subtotaltaxfixed.replace(/\B(?=(\d{3})+(?!\d))/g, ",");
        const replacedsubtotaldiscountfixed = subtotaldiscountfixed.replace(/\B(?=(\d{3})+(?!\d))/g, ",");
        document.getElementById("subtotaltax").value =  "₱ " + replacedsubtotaltaxfixed;
        document.getElementById("subtotalDiscount").value = "₱ " + replacedsubtotaldiscountfixed;
        document.getElementById("MI").value = "";
        document.getElementById("NoOfMonths").value = "";

        let flatInterest = document.getElementById("MIInterestPercentage").value;
        let flatPrincipal = document.getElementById("MIPrincipalPercentage").value;
        let flatPrincipalTotal = flatInterest / 100;
        let flatInterestTotal = flatPrincipal / 100;
        let flatPrincipalTotalFixed = dp1 * flatPrincipalTotal;
        let flatInterestTotalFixed = dp1 * flatInterestTotal;

       let replacedflatInterestTotalFixed = flatInterestTotalFixed.replace(/\B(?=(\d{3})+(?!\d))/g, ",");
       let replacedflatPrincipalTotalFixed = flatPrincipalTotalFixed.replace(/\B(?=(\d{3})+(?!\d))/g, ",");
        document.getElementById("Interest").value = "₱ " + replacedflatInterestTotalFixed;
        document.getElementById("Principal").value = "₱ " + replacedflatPrincipalTotalFixed;
    ...
    <script>
            var table = document.getElementById('dtlotDescRecord');
                for(var i = 1; i < table.rows.length; i++){
                    table.rows[i].onclick = function(){
                        ...
                        document.getElementById("totalContractPrice3").value = this.cells[7].innerHTML;
                        document.getElementById("price").value = this.cells[7].innerHTML;
                        let dpPercentage1 =  document.getElementById("dpPercentage").value;
        let a12 =  document.getElementById("taxs1").value;
        ...
        let balance1 = (parseFloat(newStr2)  - parseFloat(dp1));
        let balance1Fixed = balance1.toFixed(2);
        replacebalance1Fixed=balance1Fixed.replace(/\B(?=(\d{3})+(?!\d))/g, ",");
        document.getElementById("balance").value = "₱ " + replacebalance1Fixed;
        let discounts123 =  document.getElementById("discounts1").value;
        ...
        const subtotaltaxfixed = subtotaltax12.toFixed(2);
        const subtotaldiscountfixed = discountPrice1234.toFixed(2);
        replacedsubtotaltaxfixed=subtotaltaxfixed.replace(/\B(?=(\d{3})+(?!\d))/g, ",");
        replacedsubtotaldiscountfixed=subtotaldiscountfixed.replace(/\B(?=(\d{3})+(?!\d))/g, ",");
        document.getElementById("subtotaltax").value =  "₱ " + replacedsubtotaltaxfixed;
        document.getElementById("subtotalDiscount").value = "₱ " + replacedsubtotaldiscountfixed;
        document.getElementById("MI").value = "";
        document.getElementById("NoOfMonths").value = "";
