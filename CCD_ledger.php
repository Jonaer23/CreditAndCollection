                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div>
                                        <table class="table"   cellspacing="0" >
                                            ...
                                            <input type="text"  class="form-control" style="border:none; padding-left: 10px; background-color: #ebf5ff;  font-size: 13px; " id="contractCode" name="contractCode" >  
                                            </td>
                                            <td style="border: none; color:#2F4F4F">O.R. / P.R. No
                                            <input type="text"  class="form-control" style="border:none; padding-left: 10px; background-color: #ebf5ff;  font-size: 13px; " id="ORPR" name="ORPR" >  
                                            </td>
                                            <td style="border: none; color:#2F4F4F" >
                                            Price
                                                <br> <input  type="text" pattern="^\₱\d{1,3}(,\d{3})*(\.\d+)?₱" data-type="currency"  class="form-control" style="border:none; padding: 10px; background-color: #ebf5ff;  font-size: 13px;" id="price" name="price" > 
                                            </td>
                                            <td style="border: none; color:#2F4F4F" >
                                            Date <br> <input  type="date" class="form-control" style="border:none; margin-top:8px; padding: 10px; background-color: #ebf5ff;   font-size: 13px;" id="b_Date" name="b_Date" >
                                            </td>
                                            <td style="border: none; width: 190px; color:#2F4F4F" >
                                            Cut-off
                                                <br><select  type="text"  class="form-control" style="border:none; padding: 8px; background-color: #ebf5ff;   font-size: 13px;" id="cutOff" name="cutOff">
                                        ...
                                        <table class="table"   cellspacing="0" >
                                            ...
                                            Name of Spouse
                                                <br> <input  type="text" class="form-control" style="border:none; padding: 10px; background-color: #ebf5ff;   font-size: 13px;" id="spouseName" name="spouseName" > 
                                            Company Name
                                                <br> <input   type="text" class="form-control" style="border:none; padding: 10px; background-color: #ebf5ff;  font-size: 13px;" id="companyName" name="companyName" > 
                                                
                                            </td>
                                            
                                            <td style="border: none; width: 55%; color:#2F4F4F" >
                                            Residence Address <br> <input  type="text" class="form-control" style="border:none; padding: 10px; background-color: #ebf5ff;  font-size: 13px;" id="residentAddress" name="residentAddress" >
                                            Billing Address <br> <input  type="text" class="form-control" style="border:none; padding: 10px; background-color: #ebf5ff;   font-size: 13px;" id="billingAddress" name="billingAddress" >
                                            Company Address <br> <input  type="text" class="form-control" style="border:none; padding: 10px; background-color: #ebf5ff;  font-size: 13px;" id="companyAddress" name="companyAddress" >
                                        
                                            </td>
                                            <td style="border: none; width: 20%; color:#2F4F4F" >
                                                <p style="margin-bottom: 8.5px"> Tel. No.</P>
                                                <input type="tel"   class="form-control" style="border:none; background-color: #ebf5ff;   font-size: 13px;"  onkeypress="return onlyNumberKey(event)" id="residentialPhoneno" name="residentialPhoneno" >
                                                Occupation
                                                <br> <input type="text"  class="form-control" style="border:none; padding: 10px; background-color: #ebf5ff;   font-size: 13px;" id="spouseOccupation" name="spouseOccupation" >
                                                <p style="margin-bottom: -8px"> Tel. No.</P>
                                                <br> <input type="tel"  class="form-control" style="border:none;  background-color: #ebf5ff;   font-size: 13px;"  onkeypress="return onlyNumberKey(event)" id="companyTellNo" name="companyTellNo" >
                            ...
                            <div class="table-responsive" style="width: 100%;" >
                                <table id="dtlotDescRecord" class="table table-striped table-bordered table-sm" style= "color:#4a4949 " cellspacing="0" width="100%">
                                    <thead>
                                    
                                         <tr style="background-color: #00a8e8">
                                            <th class="th-sm" style= "width: 2%; font-size: 14px; color:#ffffff ">ID</th>
                                            <th class="th-sm" style= "width: 10%;font-size: 14px; color:#ffffff ">Block</th>
                                            <th class="th-sm" style= "width: 10%; font-size: 14px; color:#ffffff ">Section</th>
                                            <th class="th-sm" style= "width: 5%; font-size: 14px; color:#ffffff ">Lot No.</th>
                                            ...
                                            <th class="th-sm" style= "width: 10%; font-size: 14px; color:#ffffff ">Type/ Class</th>
                                    ...
                                    ?>
                                            ...
                                            <td  style= "width: 2%;font-size: 14px; color:#4a4949 " class="lot_id"><?=$row['id']?></td>
                                            <td  style= "width: 10%;font-size: 14px; color:#4a4949 " class="lot_block"><?=$row['block']?></td>
                                            <td  style= "width: 10%;font-size: 14px; color:#4a4949 " class="lot_section"><?=$row['section']?></td>
                                            <td  style= "width: 5%;font-size: 14px; color:#4a4949 " class="lot_no"><?=$row['lot_no']?></td>
                                            <td  style= "width: 10%;font-size: 14px; color:#4a4949 " class="lot_area"><?=$row['area']?></td>
                                            <td  style= "width: 10%;font-size: 14px; color:#4a4949 " class="lot_phase"><?=$row['phase']?></td>
                                            <td  style= "width: 10%;font-size: 14px; color:#4a4949 " class="lot_type"><?=$row['type']?></td>
                                            <td  style= "width: 10%;font-size: 14px; color:#4a4949 " class="ListPrice"><?=$row['ListPrice']?></td>
                                            <td  style= "width: 6%;font-size: 14px; color:#4a4949 ">
                                            
                                                <a href="#" onclick="toggleModal(this, 1)" data-toggle="modal" data-target=".lotdesc" style="color:#ffffff; font-size:12px; padding: 5px;width: 100%; background-color: #ef476f" class="btn btn-primary"  data-controls-modal="myModal" data-backdrop="static" data-keyboard="false"><i class="fas fa-cart-plus"></i> Get</a></th>
                                ...
                                <div style="padding: 0px 13px;">
                                    <div  style="width: 50%; float: left;">
                                        <table class="table"   cellspacing="0" >
                                            ...
                                            <input placeholder="Block" class="form-control" style="padding:0px 15px; font-size: 13px; margin-bottom:10px;color:#4a4949" id="LDblock" name="LDblock"  ></input>
                                            <input placeholder="Section" class="form-control" style="padding:0px 15px; font-size: 13px; margin-bottom: 10px;color:#4a4949" id="LDsection" name="LDsection"  ></input>
                                            <input placeholder="Area" class="form-control" style="padding:0px 15px; font-size: 13px; margin-bottom: 10px;color:#4a4949" id="LDarea" name="LDarea"  ></input>
                                            <input placeholder="Phase" class="form-control" style="padding:0px 15px; font-size: 13px; margin-bottom: 10px;color:#4a4949" id="LDphase" name="LDphase"  ></input>
                                            <input placeholder="Type" class="form-control" style="padding:0px 15px; font-size: 13px; margin-bottom: 10px;color:#4a4949" id="LDtype" name="LDtype"  ></input>
                                           ...
                                           <p style="padding-top: 5px;"> Terms :</p>
                                            ...
                                            <tr style="border: none;">
                                            <td style="border: none; width: 50%; color:#4a4949; font-size: 13px;background-color: Transparent;padding-left:15px;padding-right:0px;padding-bottom:0px;padding-top:0px;margin:0px; font-weight: bold" >
                                            Mode of Payment :
                                            </td>
                                            <td style="border: none;background-color: transparent;color:#4a4949;padding-left:15px;padding-right:15px;padding-bottom:0px;padding-top:0px;margin:0px; font-weight: bold;" >
                                              <select  type="text"  class="form-control" style="padding: 8px; color:#4a4949;  font-size: 13px;" id="modeOfpayment" name="modeOfpayment">
                                                    <option > --- SELECT PAYMENT METHOD ---</option> 
                                                    <option style="color:#4a4949" name="cash" value="Cash"> Cash</option> 
                                                    <option style="color:#4a4949" name="onlinePayment" value="onlinePayment"> Online Payment</option> 
                                                    </select>    
                                        </td>
                                            </tr>
                                        </table>
                                    ...
                                    <div  style="width: 50%; float: right; border-color: #5B7EDE">
                                        <table class="table"   cellspacing="0"   >
                                            ...
                                            <input placeholder="₱ 0.00" style="padding:0px 15px; font-size: 13px; width: 92%; margin:0px; background-color: #e8e4c9 ;border: none;color:#4a4949; width: 92%" id="taxs1" name="taxs1"   ></input>
                                           ...
                                           <td style="border: none;background-color: #5B7EDE;font-size: 13px;color:white;padding:0px 15px;margin:0px; font-weight: bold;" >
                                            ...
                                            <tr style="border: none">
                                                ...
                                                Less Discount :
                                                    ...
                                                    <input placeholder="₱ 0.00" style="padding:0px 15px; font-size: 13px; width: 92%; margin:0px; background-color: #e8e4c9 ;border: none;color:#4a4949;width: 92%"  id="discounts1" name="discounts1"   ></input>
                                                   <script>
                                                    let tableRowElement1;
                                                   function toggleModal1(element1) {
                                                    tableRowElement1 = element1.parentElement.parentElement;
                                           ...
                                           <td id="PreNeedPrice" style="border: none;background-color: #5B7EDE;font-size: 13px;color:white;padding:0px 15px;margin:0px; font-weight: bold;" >
                                            Total Contract Price :
                                             ...
                                             <td style="border: none;background-color: #5B7EDE;color:#4a4949;padding:0px 15px;margin:0px;" >
                                            <input readonly placeholder="₱ 0.00" pattern="^\₱\d{1,3}(,\d{3})*(\.\d+)?₱" data-type="currency"  style="padding:0px 15px; width: 92%; font-size: 13px; margin:0px; background-color: #FDFDFD ;border: none;color:#4a4949" id ="totalContractPrice3" name ="totalContractPrice3"></input>
                                            </td>
                                            </tr>
                                           ...
                                           <td id="AtNeedPrice" hidden style="border: none;background-color: #5B7EDE;font-size: 13px;color:white;padding:0px 15px;margin:0px; font-weight: bold;" >
                                            At-Needs TCP :
                                            </td>
                                           
                                             <td hidden style="border: none;background-color: #5B7EDE;color:#4a4949;padding:0px 15px;margin:0px;" >
                                            <input placeholder="₱ 0.00" style="padding:0px 15px; font-size: 13px; margin:0px; background-color: #e8e4c9 ; width: 92%;border: none;color:#4a4949"></input>
                                            </td>
                                            </tr>
                                            <tr id="downpaymenttr" style="border: none; ">
                                           <td style="border: none;background-color: #5B7EDE;font-size: 13px;color:white;padding:0px 15px;margin:0px; font-weight: bold;" >
                                            Downpayment : <input  placeholder="0.00" oninput="computedp()" pattern="^\%\d{1,3}(,\d{3})*(\.\d+)?%"    type="number" style="float: right; padding:0px 5px; font-size: 13px; margin:0px; background-color: #e8e4c9 ;border: none;color:#4a4949;width: 25%"  id="dpPercentage" name="dpPercentage"   ></input> <a style= "float: right; font-size: 13px; margin-right:5px; border: none;color:#fffff;width: 5%">% </a>
                                            </td>
                                             <td style="border: none;background-color: #5B7EDE;color:#4a4949;padding:0px 15px;margin:0px;" >
                                           ...
                                           <td style="border: none;background-color: #5B7EDE;font-size: 13px;color:white;padding:0px 15px;margin:0px; font-weight: bold;" >
                                            ...
                                            <input placeholder="₱ 0.00" hidden readonly pattern="^\₱\d{1,3}(,\d{3})*(\.\d+)?₱" data-type="currency"  style="padding:0px 15px; width: 92%; font-size: 13px; margin:0px; background-color: #e8e4c9 ;border: none;color:#4a4949" id="balance1" name="balance1"  ></input>
                                           ...
                                           <td id="monthlyInstallmenttexttd" style="border: none;background-color: #5B7EDE;font-size: 13px;color:white;padding:0px 15px;margin:0px; font-weight: bold;" >
                                            Monthly Installment :
                                            </td>
                                             <td id="monthlyInstallmenttd" style="border: none;background-color: #5B7EDE;color:#4a4949;padding:0px 15px;margin:0px;" >
                                            ...
                                            <tr id="factorRatetr" style="border: none; display:none">
                                            <td style="border: none;background-color: #5B7EDE;font-size: 13px;color:white;padding:0px 15px;margin:0px; font-weight: bold;" >
                                            Factor rate : <input  placeholder="0.00"  pattern="^\%\d{1,3}(,\d{3})*(\.\d+)?%"    type="number" style="float: right; padding:0px 5px; font-size: 13px; margin:0px; background-color: #e8e4c9 ;border: none;color:#4a4949;width: 25%"  id="factorratePercentage" name="factorratePercentage"  readonly ></input> <a style= "float: right; font-size: 13px; margin-right:5px; border: none;color:#fffff;width: 5%">% </a>
                                             ...
                                             <td style="border: none;background-color: #5B7EDE;color:#4a4949;padding:0px 15px;margin:0px;" >
                                            <input placeholder="₱ 0.00" id="factorrate" name="factorrate" readonly    style="padding:0px 15px; width: 92%; font-size: 13px; margin:0px; background-color: #e8e4c9 ;border: none;color:#4a4949" ></input> 
                                            </td>
                                            </tr>
                                           ...
                                           <td style="border: none;background-color: #5B7EDE;color:white;font-size: 13px;padding:0px 15px;margin:0px; font-weight: bold;" >
                                            ...
                                            <td style="border: none;background-color: white;color:#5B7EDE;padding:0px 15px;margin: 10px 0px ;" >
                                                    <button type="submit" name="btnSaveLedger" class="btn btn-primary" style="padding: 2px 15px; float: right; ;margin: 15px 0px ;" >Save</button>
                                            </td>
                                            </tr>
                                        </table>
                                    </div>
                            ...
                            <div class="modal-body" style="color:#4a4949">
                                 <table id="dtcryptRecord" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
                                            <tr style="border: 2px solid #e3e6f0">
                                                ...
                                                <input  style="padding:0px 15px; font-size: 13px; margin:0px; background-color: white;border: none;color:#4a4949; width: 100%" type="number" pattern="[0-9]+([\,|\.][0-9]+)?" name ="tax" id ="tax" ></input>
                            ...
                            <div class="modal-body" style="color:#4a4949">
                                 <table id="dtcryptRecord" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
                                            <tr style="border: 2px solid #e3e6f0">
                                                ...
                                                <td  style= "font-size: 14px; color:#4a4949 ">
                                                <input  style="padding:0px 15px; font-size: 13px; margin:0px; background-color: white;border: none;color:#4a4949; width: 100%" type="number" pattern="[0-9]+([\,|\.][0-9]+)?" name ="discount" id ="discount" ></input>
                                                <input  style="padding:0px 15px; font-size: 13px; margin:0px; background-color: transparent;border: none;color:#4a4949; width: 100%" type="number" hidden></input>
                            ...
                            <div class="modal-body" style="color:#4a4949">
                                 <table id="dtcryptRecord" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
                                            <tr style="border: 2px solid #e3e6f0">
                                                ...
                                                <td  style= "font-size: 14px; color:#4a4949 ">
                                                <input  style="padding:0px 15px; font-size: 13px; margin:0px; background-color: white;border: none;color:#4a4949; width: 100%" type="number" pattern="[0-9]+([\,|\.][0-9]+)?" name ="PCF1" id ="PCF1" ></input>
                                                <input  style="padding:0px 15px; font-size: 13px; margin:0px; background-color: transparent;border: none;color:#4a4949; width: 100%" type="number" hidden></input>
...
<div class="modal fade bd-example-modal-vat" tabindex="-1" role="dialog" id="Markup" aria-labelledby="myLargeModalLabel" aria-hidden="true" style=" margin: auto; bottom: 0px; left: 0px; right:0px; width: 98%; color:#2F4F4F">
  <div class="modal-dialog" role="document">
                            ...
                            <div class="modal-body" style="color:#4a4949">
                                 <table id="dtcryptRecord" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
                                            <tr style="border: 2px solid #e3e6f0">
                                                <td  style= "font-size: 14px; color:#4a4949 ">Perpetual Care Funds :</td>
                                                <td  style= "font-size: 14px; color:#4a4949 ">
                                                <input  style="padding:0px 15px; font-size: 13px; margin:0px; background-color: white;border: none;color:#4a4949; width: 100%" type="number" pattern="[0-9]+([\,|\.][0-9]+)?" name ="markup1" id ="markup1" ></input>
                                                <input  style="padding:0px 15px; font-size: 13px; margin:0px; background-color: transparent;border: none;color:#4a4949; width: 100%" type="number" hidden></input>
    ...
    function computedp() {
        ...
        document.getElementById("MI").value = "₱ " +  replacedmonthlyInstallment1fixed;
        }
            ...
            var table = document.getElementById('dtlotDescRecord');
                for(var i = 1; i < table.rows.length; i++){
                    table.rows[i].onclick = function(){
                        ...
                        document.getElementById("LDblock").value = this.cells[1].innerHTML;
                        document.getElementById("LDsection").value = this.cells[2].innerHTML;
                       
                        document.getElementById("LDarea").value = this.cells[4].innerHTML;
                        document.getElementById("LDphase").value = this.cells[5].innerHTML;
                        document.getElementById("LDtype").value = this.cells[6].innerHTML;
