            ...
            <div class="card-body">
                                ...
                                <div>
                                        <table class="table"   cellspacing="0" >
                                            ...
                                            Cut-off
                                                <br> <input type="text" class="form-control" style="border:none; padding: 10px; background-color: #ebf5ff;   font-size: 12px;" id="Date" name="Date" readonly>
                                ...
                                <div class="table-responsive" id="showledger" style="color:#2F4F4F;display:none" >
                                 <table id="userTable"  class="display dataTable table table-striped b-t b-light"  cellspacing="0" width="100%">
                                    <thead>
                                        ...
                                        <tr  style="background-color: #007ea7">
                                            <th class="th-sm" style= "width: 5% ; font-size: 12px; color:#ffffff">No</th>
                                            <th class="th-sm" style= "width: 5% ; font-size: 12px; color:#ffffff">ContractCode</th>
