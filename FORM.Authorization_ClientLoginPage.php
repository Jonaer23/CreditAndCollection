...
<body class="ftco-section">
            ...
            <div class="row justify-content-center" >
                ...
                <div class="login-wrap p-4 p-md-5" style="background-color: rgba(255, 255, 255, 0.7);  height: 100%">
                        <div class="d-flex" style="justify-content: center;">
                            <img src="uploads/southspring_logo.png" ></img> 
                        </div>
                                ...
                                <div class="form-group d-md-flex" style="margin-top: -25px">
                                    ...
                                    <div class="w-50 text-right" style=" width: 60%; margin-left: 0px; float:right;">
                                        <a href="" class="checkbox-wrap checkbox-primary mb-0" style="font-size: 12px;"
                                            data-toggle="modal" data-target="#lotvouchercodeModal">Set an appointment ?
                                        </a>
                                    </div>
                                </div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            function fetchAvailableTimeSlots() {
                ...
                if (selectedDate !== "") {
                    fetch("FETCH.getAppointment.php", {
                        method: "POST",
                    ...
                    .then(data => {
                        if (Array.isArray(data)) {
                            data.forEach(availableDate => {
                                availableDate.timeSlots.forEach(timeSlot => {
            ...
            // Any other JavaScript code you have can be placed here
        });
    ...
    <script src="myscript/Function.AuthorizationClientPage.js"></script>
    <script src="myscript/sales_insertAppointment.js"></script>
