...
balance, MI1, NoOfMonths, MI2, cryptarea, cryptclassification, status
FROM tbl_ledger
WHERE status = ?";
...
if ($stmt->execute()) {
    ...
    $subtotaltax,  $subtotalDiscount,  $dpPercentage,  $dpPercentage2,  $balance,  $MI1,  $NoOfMonths,  $MI2,  $Cryptarea,  $Crypttype,  $status);
