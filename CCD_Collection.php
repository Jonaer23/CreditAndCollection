            ...
            <div class="card-body">
                                ...
                                <div>
                                    ...
                                    <table class="table"   cellspacing="0" style="border: none; width:100%;color:#4a4949; float: right; margin-right: 10px; ">
                                         ...
                                         <tr  style=" background-color: #007ea7 "> 
                                               <th colspan="2" style="color:#ffffff; font-size: ">Lot Description</th>
                                           </tr>
                                           <tr style="border: none;">
                                           ...
                                           <dl class="row">
                                            ...
                                            <input placeholder="Terms" required class="form-control" style="padding:0px 15px; font-size: 13px; margin-bottom: 10px;color:#4a4949" id="terms" name="terms"  readonly></input>
                                            </td>
                                            </tr>
                                            ...
                                            <td style="border: none;background-color: transparent;color:#4a4949;padding-left:15px;padding-right:15px;padding-bottom:0px;padding-top:15px;margin:0px; font-weight: bold;" >
                                            <input placeholder="Mode of Payment" required class="form-control" style="padding:0px 15px; font-size: 13px; margin-bottom: 10px;color:#4a4949" id="modeOfpayment" name="modeOfpayment"  readonly></input>
                                            </td>
                                            </tr>
                                    ...
                                    <div  style="width: 50%; float: right; border-color: #5B7EDE">
                                        <table class="table"   cellspacing="0"   >
                                           ...
                                           <td style="border: none;background-color: #5B7EDE;color:white;font-size: 13px;padding:0px 15px;margin:0px; font-weight: bold;" >
                                            ...
                                            <tr style="border: none; padding-bottom: 30px; ">
                                            <td style="border: none;background-color: transparent;color:#5B7EDE;padding:0px 15px;margin:0px; " >
                                            .
                                            <input value="<?php echo $Name; ?>" id="user" name="user" hidden><br>
                                            </td>
                                            <td style="border: none;background-color: transparent;color:#5B7EDE;margin:0px; float:right" >
                                            <br>
