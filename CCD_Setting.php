...
$Name = $_SESSION['Fullname'];
  if(isset($_SESSION['Access']) && $_SESSION['Access'] == "Admin"  && $_SESSION['Department'] == "SedgeInventory" && $_SESSION['Position'] == "Programmer") {
?>
    <!DOCTYPE html>
    <html lang="en">
 ...
 .available-row {
        color: #00FF00; /* Light green for Available status */
    }

    .active-row {
       color: #C46210; /* Light orange for Active status */
    }

    .purchase-row {
        color: #ffc2d0; /* Light pink for purchase status */
    }
        div.ChildrenTable {
            width: 100%;
            float: left;
    ...
    <body id="page-top" style="font-family: Roboto, Arial, sans-serif;">
        <div id="wrapper">
            ...
            <ul class="navbar-nav bg-sedge-primary-color sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <li class="nav-item ">
                    <a class="nav-link" href="CCD_Setting.php">
                        <i class="fas fa-fw fas fa-database"></i></i>
                        <span>Lot Inventory</span></a>
                </li>
                <li class="nav-item ">
                    <a class="nav-link" href="CCD_Crypt.php">
                        <i class="fas fa-fw fas fa-database"></i></i>
                        <span>Crypt Inventory</span></a>
                </li>
                <!-- Nav Item - Tables -->
                <!-- Divider -->
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-header py-3" style="background-color: #003459;">
                                <h6 class="m-0 font-weight-bold" style="color: #ffffff; ; float: left">LOT DESCRIPTION</h6> 
                               <button id="settingBtn" style="background-color: transparent; border: none; float: right; margin: 0px" data-toggle="modal" data-target="#myModal"><span id="settingIcon" class="setting-icon"><i class="fas fa-cog"></i></span></button>
                            ...
                            <div class="card-body">
                                <div class="card shadow mb-4">
                                     ...
                                     <tr style="border: 2px solid #e3e6f0; color: #ffffff; background-color:#007ea7 "> 
                                        <th scope="col" class="table-cell" style="color:#ffffff ; font-size: 14px; ">ID</th>
                                        <th  scope="col" class="table-cell" style="color:#ffffff ; font-size: 14px; ">Section</th>
                                        <th  scope="col" class="table-cell" style="color:#ffffff ; font-size: 14px; ">Lot No.</th>
                                        <th  scope="col" class="table-cell" style="color:#ffffff ; font-size: 14px; ">Area</th>
                                        <th  scope="col" class="table-cell" style="color:#ffffff ; font-size: 14px; ">Phase</th>
                                        <th  scope="col" class="table-cell" style="color:#ffffff ; font-size: 14px; ">Type</th>
                                        <th  scope="col" class="table-cell" style="color:#ffffff ; font-size: 14px; ">Classification</th>
                                        <th  scope="col" class="table-cell" style="color:#ffffff ; font-size: 14px; ">Status</th>
                                        <th  scope="col" class="table-cell" style="color:#ffffff ; font-size: 14px;">List Price</th>
                                        <th  scope="col" class="table-cell" style="color:#ffffff ; font-size: 14px;">Date Created</th>
                                     ...
                                     <tbody>
                                        <?php
                                            ...
                                            $sales_query = "SELECT * from tbl_lotdescription WHERE `status` IN ('Available', 'Active', 'Purchase')";
                                        ...
                                        ?>
                                            <tr style="color: #4a4949; font-size: 14px;" >
                                                ...
                                                <td class="table-cell <?=$statusColorClass?>" ><?=$row['status']?></td>
                                                <td class="table-cell"><?= '₱ ' . number_format($row['ListPrice'], 2, '.', ',') ?></td>
                                                <td class="table-cell"><?=$row['dateCreated']?></td>
                                            </tr>
                                        <?php
                                                }
                                            }
        ...
        <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog modal-dialog-centered" >
              <div class="modal-content "  style="color: #333;">
                <div class="modal-header" style="background-color: #007ea7; ">
                ...
                <div class="modal-body">
                  ...
                  <div style="padding: 0px 30px">
                        <p style=" margin-bottom: 5px" hidden>Block :</p>
                        <select id="block" name="block"  style="color: #00171f; margin-top: 5px;"  class="form-control" hidden>
                            <option value="Block I">Block I</option>
                        </select>
                        <p style=" margin-bottom: 5px">Area :</p>
                        <select id="area" name="area"  style="color: #00171f; margin-top: 5px;"  class="form-control"required>
                             <option value=""></option>
                            <option value="GARDEN OF APOLLON">GARDEN OF APOLLON</option>
                            <option value="GARDEN OF ASTRA">GARDEN OF ASTRA </option>
                            <option value="GARDEN OF APHRODITE">GARDEN OF APHRODITE </option>
                            <option value="GARDEN OF DELPHIA">GARDEN OF DELPHIA </option>
                            <option value="GARDEN OF EVANIA">GARDEN OF EVANIA </option>
                            <option value="GARDEN OF KOSMA">GARDEN OF KOSMA </option>
                            <option value="GARDEN OF PHEDORA">GARDEN OF PHEDORA </option>
                            <option value="GARDEN OF RENA">GARDEN OF RENA </option>
                            <option value="GARDEN OF URANUS">GARDEN OF URANUS </option>
                            <option value="GARDEN OF LOTUS">GARDEN OF LOTUS </option>
                            <option value="GARDEN OF ALETHEA">GARDEN OF ALETHEA </option>
                            <option value="GARDEN OF CORINTH">GARDEN OF CORINTH </option>
                            <option value="GARDEN OF ATHENA">GARDEN OF ATHENA </option>
                            <option value="GARDEN OF CENTENNIAL">GARDEN OF CENTENNIAL </option>
                            <option value="GARDEN OF EROS">GARDEN OF EROS </option>
                            <option value="GARDEN OF ATLAS">GARDEN OF ATLAS </option>
                            <option value="GARDEN OF URANIA">GARDEN OF URANIA </option>
                        </select>
                        <p style=" margin-bottom: 5px">Section :</p>
                        <select id="section" name="section"  style="color: #00171f; margin-top: 5px;"  class="form-control"required>
                           
                        </select>
                        <p style=" margin-bottom: 5px">Number of lots :</p>
                        <input id="noLots" name="noLots" type="number"  style="color: #00171f; margin-top: 5px;"  class="form-control"required />
                        
                        <p style=" margin-bottom: 5px">Phase :</p>
                        <select id="phase" name="phase"  style="color: #00171f; margin-top: 5px;"  class="form-control"required>
                            <option value=""></option>
                        ...
                        <select id="type" name="type"  style="color: #00171f; margin-top: 5px;"  class="form-control"required>
                            <option value=""></option>
                            <option value="FAMILY ESTATE">FAMILY ESTATE</option>
                            <option value="LAWN LOT">LAWN LOT</option>
                        </select>
                        <p style=" margin-bottom: 5px">Classification :</p>
                        <select id="classification" name="classification"  style="color: #00171f; margin-top: 5px;"  class="form-control"required>
                            <option value=""></option>
                            ...
                            <option value="CORNER LOTS">CORNER LOTS</option>
                        </select>
                        <p style=" margin-bottom: 5px">Status :</p>
                        <select id="status" name="status"  style="color: #00171f; margin-top: 5px;"  class="form-control"required>
                            <option value=""></option>
                            <option value="Available">Available</option>
                            <option value="Active">Active</option>
                            <option value="Purchased">Purchased</option>
                        </select>
                        <p style=" margin-bottom: 5px">List Price :</p>
                        <input type="text" id="listprice" name="listprice" style="color: #00171f;"  class="form-control" pattern="^\₱\d{1,3}(,\d{3})*(\.\d+)?₱" data-type="currency" required>
                  </div>
                </div>
        ...
        <script>
          ...
          function saveData() {
            ...
            var noLots = document.getElementById("noLots").value;
            ...
            $.ajax({
              type: "POST",
              url: "lotsave_data.php",
              data: formData,
              dataType: "json",
              success: function(response) {
                // Show success notification
                document.getElementById("notificationDiv").innerHTML = '<div class="alert alert-success">Data saved successfully!</div>';
              },
              error: function() {
                // Show error notification
                document.getElementById("notificationDiv").innerHTML = '<div class="alert alert-danger">Error saving data!</div>';
              }
            });
          }
        
          // Bind the Save button click event to the saveData function
          document.querySelector("#myModal .modal-footer button.btn-primary").addEventListener("click", function() {
            saveData();
          });
        </script>
          <script>
    ...
    $(document).ready(function() {
        $('#area').change(function() {
            ...
            $.ajax({
                ...
                dataType: 'json',
                success: function(response) {
                    var accountNumberSelect = $('#section');
