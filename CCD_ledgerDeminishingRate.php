    ...
    <div id="wrapper">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsePages4"
                ...
                <i class="fas fa-balance1-scale"></i>
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsePages3"
                ...
                <i class="fas fa-balance1-scale-right"></i>
                            ...
                            <div class="table-responsive" style="width: 100%;" >
                                <table id="dtlotDescRecord" class="table table-striped table-bordered table-sm" style= "color:#4a4949 " cellspacing="0" width="100%">
                                    ...
                                    ?>
                                            ...
                                            <td  style= "width: 10%;font-size: 14px; color:#4a4949 " class="lot_TCP"><?=$row['ListPrice']?></td>
                                ...
                                <div style="padding: 0px 13px;">
                                    <div  style="width: 50%; float: left;">
                                        <table class="table"   cellspacing="0" >
                                            ...
                                            <input class="form-control" style="padding:0px 15px; font-size: 13px; margin-bottom:10px;color:#4a4949" id="LDblock" name="LDblock" placeholder="Block" ></input>
                                            <input class="form-control" style="padding:0px 15px; font-size: 13px; margin-bottom: 10px;color:#4a4949" id="LDsection" name="LDsection"  placeholder="Section"></input>
                                            <input class="form-control" style="padding:0px 15px; font-size: 13px; margin-bottom: 10px;color:#4a4949" id="LDarea" name="LDarea"  placeholder="Area"></input>
                                            <input class="form-control" style="padding:0px 15px; font-size: 13px; margin-bottom: 10px;color:#4a4949" id="LDphase" name="LDphase"  placeholder="Phase"></input>
                                            <input class="form-control" style="padding:0px 15px; font-size: 13px; margin-bottom: 10px;color:#4a4949" id="LDtype" name="LDtype"  placeholder="Type"></input>
                                        ...
                                        <table class="table"   cellspacing="0"   >
                                           ...
                                           <td id="PreNeedPrice" style="border: none;background-color: #5B7EDE;font-size: 13px;color:white;padding:0px 15px;margin:0px; font-weight: bold;" >
                                            Total Contract Price :
                                             ...
                                             <td style="border: none;background-color: #5B7EDE;color:#4a4949;padding:0px 15px;margin:0px;" >
                                            <input placeholder="₱ 0.00" required readonly pattern="^\₱\d{1,3}(,\d{3})*(\.\d+)?₱" data-type="currency" oninput="computedp()" style="padding:0px 15px; width: 92%; font-size: 13px; margin:0px; background-color: #FDFDFD ;border: none;color:#4a4949" id ="totalContractPrice3" name ="totalContractPrice3"></input>
                                            </td>
                                            </tr>
                                           ...
                                           <td style="border: none;background-color: #5B7EDE;color:white;font-size: 13px;padding:0px 15px;margin:0px; font-weight: bold;" >
                                            ...
                                            <td style="border: none;background-color: white;color:#5B7EDE;padding:0px 15px;margin: 10px 0px ;" >
                                                    <button type="submit" name="btnSaveDiminishingRate" class="btn btn-primary" style="padding: 2px 15px; float: right; ;margin: 15px 0px ;" >Save</button>
                                            </td>
                                            </tr>
                                        </table>
                                    </div>
                                 ...
                                 <table id="dtcryptRecord" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
                                        <?php
                                            ...
                                            <tr style="border: 2px solid #e3e6f0">
                                                ...
                                                % <input placeholder="0.00" oninput="interestCompute()" style="padding:0px 15px; font-size: 13px; margin:0px; background-color: white;border: none;color:#4a4949; width: 90%" type="number" pattern="[0-9]+([\,|\.][0-9]+)?" name ="inputInterest1" id ="inputInterest1" value="<?=$row['interest']?>" required></input>
                                            ...
                                            <tr style="border: 2px solid #e3e6f0">
                                                ...
                                                <td  style= "font-size: 14px; color:#4a4949 ">
                                                % <input placeholder="0.00" oninput="principalCompute()" style="padding:0px 15px; font-size: 13px; margin:0px; background-color: white;border: none;color:#4a4949; width: 90%" type="number" pattern="[0-9]+([\,|\.][0-9]+)?" name ="inputPrincipal1" id ="inputPrincipal1" value="<?=$row['principal']?>" required></input>
                            ...
                            <div class="modal-body" style="color:#4a4949">
                                 <table id="dtcryptRecord" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
                                            ...
                                            <tr style="border: 2px solid #e3e6f0">
                                                <td  style= "font-size: 14px; color:#4a4949 ">Interest :</td>
                                                <td  style= "font-size: 14px; color:#4a4949 ">
                                                <input placeholder="0.00" oninput="interestCompute1()" style="padding:0px 15px; font-size: 13px; margin:0px; background-color: white;border: none;color:#4a4949; width: 100%" type="number" pattern="[0-9]+([\,|\.][0-9]+)?" value="<?=$row['interest']?>" name ="inputInterest2" id ="inputInterest2" required></input>
                                            ...
                                            <tr style="border: 2px solid #e3e6f0">
                                                <td  style= "font-size: 14px; color:#4a4949 ">Principal :</td>
                                                <td  style= "font-size: 14px; color:#4a4949 ">
                                                <input placeholder="0.00" oninput="principalCompute1()" style="padding:0px 15px; font-size: 13px; margin:0px; background-color: white;border: none;color:#4a4949; width: 100%" type="number" pattern="[0-9]+([\,|\.][0-9]+)?" value="<?=$row['principal']?>" name ="inputPrincipal2" id ="inputPrincipal2"  required></input>
