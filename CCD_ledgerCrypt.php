                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div>
                                        <table class="table"   cellspacing="0" >
                                            ...
                                            <input type="text" required class="form-control" style="border:none; padding-left: 10px; background-color: #ebf5ff;  font-size: 13px; " id="contractCode" name="contractCode" >  
                                            </td>
                                            <td style="border: none; color:#2F4F4F">O.R. / P.R. No
                                            <input type="text" required class="form-control" style="border:none; padding-left: 10px; background-color: #ebf5ff;  font-size: 13px; " id="ORPR" name="ORPR" >  
                                            </td>
                                        ...
                                        <table class="table"   cellspacing="0" >
                                            ...
                                            Name of Spouse
                                                <br> <input required type="text" class="form-control" style="border:none; padding: 10px; background-color: #ebf5ff;   font-size: 13px;" id="spouseName" name="spouseName" > 
                                            Company Name
                                                <br> <input  required type="text" class="form-control" style="border:none; padding: 10px; background-color: #ebf5ff;  font-size: 13px;" id="companyName" name="companyName" > 
                                                
                                            </td>
                                            
                                            <td style="border: none; width: 55%; color:#2F4F4F" >
                                            Residence Address <br> <input required type="text" class="form-control" style="border:none; padding: 10px; background-color: #ebf5ff;  font-size: 13px;" id="residentAddress" name="residentAddress" >
                                            Billing Address <br> <input required type="text" class="form-control" style="border:none; padding: 10px; background-color: #ebf5ff;   font-size: 13px;" id="billingAddress" name="billingAddress" >
                                            Company Address <br> <input required type="text" class="form-control" style="border:none; padding: 10px; background-color: #ebf5ff;  font-size: 13px;" id="companyAddress" name="companyAddress" >
                                ...
                                <div style="padding: 0px 13px;">
                                    <div  style="width: 50%; float: left;">
                                        <table class="table"   cellspacing="0" >
                                            ...
                                            <input placeholder="level" class="form-control" style="padding:0px 15px; font-size: 13px; margin-bottom: 10px;color:#4a4949" id="level" name="level"  ></input>
                                           ...
                                           <p style="padding-top: 5px;"> Terms :</p>
                                            ...
                                            <select  type="text"  class="form-control" style="padding: 8px; color:#4a4949; font-size: 13px;" id="terms" name="terms">
                                                    <option name="selectTerms" value="selectTerms"> --- SELECT TERMS ---</option> 
