    ...
    <div class="card-body">
        ...
        <div class="card shadow mb-4">
             ...
             <tr style="border: 2px solid #e3e6f0; color: #ffffff; background-color:#007ea7 "> 
                <th scope="col" class="table-cell" style="color:#ffffff ; font-size: 14px; " hidden>ID</th>
                <th scope="col" class="table-cell" style="color:#ffffff ; font-size: 14px; ">Lot ID</th>
             ...
             <tr style="color: #4a4949; font-size: 14px; ">
                <td class="table-cell" hidden><?=$row['id']?></td>
        ...
        <div class="card shadow mb-4">
             ...
             <thead>
             <tr style="border: 2px solid #e3e6f0; color: #ffffff; background-color:#007ea7 "> 
                <th scope="col" style="color:#ffffff ; font-size: 14px; width: 2%">ID</th>
                <th scope="col" style="color:#ffffff ; font-size: 14px; width: 8%">Phase</th>
                <th  scope="col" style="color:#ffffff ; font-size: 14px; width: 8%">Level</th>
                <th  scope="col" style="color:#ffffff ; font-size: 14px;  width: 4%">Area</th>
                <th  scope="col" style="color:#ffffff ; font-size: 14px; width: 11%">Section</th>
                <th  scope="col" style="color:#ffffff ; font-size: 14px; width: 8%">Column</th>
                <th  scope="col" style="color:#ffffff ; font-size: 14px; width: 8%">Unit no.</th>
                <th  scope="col" style="color:#ffffff ; font-size: 14px; width: 10%">Classification</th>
                <th  scope="col" style="color:#ffffff ; font-size: 14px; width: 10%">List Price</th>
      ...
      <span aria-hidden="true">&times;</span>
                        ...
                        <div class="modal-body">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><input type="text"  class="form-control" id="Employee_Id"  name="Employee_Id"readonly></input></td>
                                        <td><input type="text" class="form-control" id="Fullname" name="Fullname" readonly ></td>
                                        <td><input type="text" class="form-control" id="Username" placeholder="Username" name="Username" required></td>
                                        <td><select name="Department"  class="form-control"  id="Department"class="Sedge_Select">
                                        ...
                                        <td><select class="form-control" id="Position"  name="Position" required>
                            ...
                            <option value="InternetCrew"> Internet Crew </option>
                                         ...
                                         <td><select class="form-control" id="AS_Status"  name="AS_Status" required>
                                            <option  value="Activated">Activated</option>
                                            <option value="Deactivated">Deactivated &nbsp;&nbsp;</option>
                                            </select></td>
                                        <td><select  class="form-control" id="Access" name="Access" required>
