...
$stmt = $conn->prepare("SELECT id, daysDelayed, monthlyInstallment, reinstatementfee, dateModified, paymentDueDate FROM tbl_flatinterest WHERE userAccount = :username AND reinstatementstatus = 1");
