...
$query = "SELECT monthlyInstallment FROM tbl_flatinterest WHERE remarks = 'Monthly Payment' AND userAccount = ? ORDER BY id DESC LIMIT 1";
...
if ($stmt->execute()) {
    ...
    $data = array('salesRevenue' => (float)$row['monthlyInstallment']);
