                                        ...
                                        <div class="card-body">
                                            <div class="row no-gutters align-items-center">
                                                <div class="col mr-2">
                                                    ...
                                                    if ($result->num_rows > 0) {
                                                        $row = $result->fetch_assoc();
                                                        $monthlyEarnings = '₱ ' . number_format((float)$row['monthly_earnings'], 2, '.', ',');
                                                        echo "<p>$monthlyEarnings</p>";
                                                    } else {
                                                        echo "<p>No monthly earnings found.</p>";
                                                    }
                                ...
                                <table class="table table-bordered" id="history" width="100%" cellspacing="0">
                                    <thead>
                                        <tr class="text-xs font-weight-bold text-uppercase mb-1"
                                            ...
                                            <th scope="col"></th>
                                            <th scope="col"></th>
                                            <th scope="col">ISS CODE</th>
                                            <th scope="col">USER ACCOUNT</th>
                                            <th scope="col">USERNAME</th>
                                            <th scope="col">DISINTERMENT</th>
                                            <th scope="col">DISINTERMENT DATE</th>
                                            <th scope="col">DISINTERMENT TIME</th>
                                            <th scope="col">TOTAL DISINTERMENT FEE</th>
                        ...
                        <div class="card-body">
                                <div class="card shadow mb-4 text-uppercase mb-1"  style="color: #333; font-size: 12px; padding: 20px 20px;"  >
                                    ...
                                    <div style=" justify-content: space-between; padding: 10px;">
                                        ...
                                        <br>
                                        <span class="text-gray-900 text-uppercase mb-1" style="font-size: 12px">
                                            ISS code: <span class="text-gray-900 text-uppercase mb-1" style="font-size: 12px; text-decoration: underline;" id="ISSCode"></span>
                                        </span>
                                        <br>
                                        <span class="text-gray-900 text-uppercase mb-1" style="font-size: 12px">
                                        ...
                                        <table style="width: 30%; float: left">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td><span><p class="text-gray-900 text-uppercase mb-1" style="font-size: 12px">VAT : </p></span></td>
                                                ...
                                                <tr>
                                                    <td><span><p class="text-gray-900 text-uppercase mb-1" style="font-size: 12px">DISCOUNT : </p></span></td>
                                        ...
                                        <table style="width: 30%;">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td><span><p class="text-gray-900 text-uppercase mb-1" style="font-size: 12px">Less: disinterment previledge: </p></span></td>
                                                    <td style="border-bottom: 1px solid; padding-right: 5px; padding-top: 5px"><span><p class="text-gray-900 text-uppercase mb-1" style="font-size: 12px; text-align: right" id="IP"></p></span></td>
                                                </tr>
                                                <tr>
                                                    <td><span><p class="text-gray-900 text-uppercase mb-1" style="font-size: 12px">add: disinterment mark-up : </p></span></td>
                                                    <td style="border-bottom: 1px solid; padding-right: 5px; padding-top: 5px"><span><p class="text-gray-900 text-uppercase mb-1" style="font-size: 12px; text-align: right" id="IMU"></p></span></td>
                                                </tr>
                                                <tr>
                                                    <td><span><p class="text-gray-900 text-uppercase mb-1" style="font-size: 12px"><strong>Total disinterment fee :</strong> </p></span></td>
                                                    <td style="border-bottom: 1px solid; padding-right: 5px; padding-top: 5px"><span><p class="text-gray-900 text-uppercase mb-1" style="font-size: 12px; text-align: right" id="TIF"></p></span></td>
                                                </tr>
                                            </tbody>
                                        </table>
            ...
            columnDefs: [
                ...
                
                {
                    ...
                    render: function(data, type, row) {
                        if (type === 'display') {
                            if (isNaN(data)) {
                                return '<span style="font-size: 12px" class="text-gray-900">₱ 0.00</span>';
                            } else {
                                var currencyFormatted = parseFloat(data).toFixed(2);
                                return '<span style="font-size: 12px" class="text-gray-900">₱ ' + currencyFormatted.replace(/\B(?=(\d{3})+(?!\d))/g, ",") + '</span>';
                            }
                        }
                        return data;
                    }
                ...
                },
               {
                  targets: [9],
                    ...
                    render: function(data, type, row) {
                        ...
                        return '<span class="' + backgroundColorClass + ' ' + textColorClass + ' text-center d-block py-1 px-3 rounded" style="font-size: 12px;">' + data + '</span>';
                    }
                },
            ]
        });
       ...
       function populateTable(data) {
                ...
                $.each(data, function(index, item) {
                    ...
                    var sanitizedItem = {
                        ...
                        DisintermentNumber: sanitizeInput(item.DisintermentNumber),
                        CustomerCode: sanitizeInput(item.CustomerCode),
                        CustomerName: sanitizeInput(item.CustomerName),
                        IntermentSite: sanitizeInput(item.IntermentSite),
                        DisintermentDate: formatDate (item.DisintermentDate)),
                        DisIntermentTime: sanitizeInput (item.DisIntermentTime), // Decode HTML entities
                        DisIntermentFee: sanitizeInput(item.DisIntermentFee),
                    ...
                    historyTable.row.add([
                        sanitizedItem.id,
                        getActionButton(sanitizedItem.CustomerCode, sanitizedItem.DisintermentNumber),
                        sanitizedItem.CustomerName,
                        sanitizedItem.IntermentSite,
                        sanitizedItem.DisintermentDate,
                        sanitizedItem.DisIntermentTime,
                        sanitizedItem.DisIntermentFee,
                        sanitizedItem.totalIntermentfee,
                        sanitizedItem.status,
                        getVerifyButton(sanitizedItem.CustomerCode, sanitizedItem.id, sanitizedItem.DisintermentNumber)
                        
                    ]).draw(false);
                });
            }
            // Fetch ledger data for a specific account
            function fetchLedgerAccount(CustomerCode, DisIntermentnumber) {
            $.ajax({
            ...
            function getActionButton(CustomerCode, DisintermentNumber) {
                  return `<button class="text-info btndownloadModal" style=" white-space: nowrap; margin: 0 auto; display: block; border: none; background-color: transparent;" data-account-id="${CustomerCode}" data-account-id4="${DisintermentNumber}" data-toggle="modal" data-target="#downloadModal"><i class="fas fa-download"></i></button>`;
            }
            function getVerifyButton(CustomerCode, id, DisintermentNumber) {
                return `<button class="text-success approve " id="approve" style="white-space: nowrap; margin: 0 auto; border: none; background-color: transparent; text-align: center; padding-left: 10px" data-account-id="${CustomerCode}" data-account-id1="${id}" data-account-id2="${DisintermentNumber}"> <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-person-fill-up" viewBox="0 0 16 16">
                                                    ...
                                                    </svg></button> || <button class="text-danger declined" id="declined" style="white-space: nowrap; margin: 0 auto; border: none; background-color: transparent; text-align: center" data-account-id="${id}" data-account-id="${userAccount}"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-person-x" viewBox="0 0 16 16">
            ...
            $.ajax({
                url: "Fetch.Validation_DisintermentTableDisplay.php", // Replace with your actual server endpoint URL
                method: "POST",
                dataType: "json",
            ...
            $(document).on('click', '.btndownloadModal', function() {
                ...
                const DisIntermentnumber = $(this).data('account-id4');
                openModal(CustomerCode, DisIntermentnumber);
            ...
            function openModal(CustomerCode, DisIntermentnumber) {
                $('#customerCode').text(CustomerCode);
                $('#ISSCode').text(DisIntermentnumber);
                fetchLedgerAccount(CustomerCode, DisIntermentnumber);
                fetchIntermentAccount(CustomerCode, DisIntermentnumber);
            }
            $(document).on('click', '.approve', function() {
                const customerCode = $(this).data('account-id');
                const id = $(this).data('account-id1');
                const ISS_no = $(this).data('account-id2');
                ...
                promptForORPR(function(ORPR) {
                    if (ORPR !== null && ORPR.trim() !== '') {
                        ...
                        approveItem(customerCode, element, ORPR, id, ISS_no);
                    } else {
            ...
            $(document).on('click', '.declined', function() {
                ...
                const userAccount = $(this).data('account-id1');
                 // Get the item ID from the corresponding hidden ID <td> element
                    var element1 = this.parentNode;
                   declinedStatus(id, element1);
                   
                });
            function declinedStatus(id, element1, userAccount) {
                ...
                $.ajax({
                type: 'POST',
                url: 'CCD_Declined_PaymentIntermentVerification.php', // Replace with the actual URL to your PHP script
                data: { 
                    id: id,
                    userAccount: userAccount
                    
                }, // Pass the item ID to the PHP script
                dataType: 'json',
                success: function(response) {
            ...
            function approveItem(customerCode, element, ORPR, id, ISS_no) {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'CCD_Approved_PaymentIntermentVerification.php', // Replace with the actual URL to your PHP script
                    data: {
...
<script>
    ...
    <script>
        function fetchIntermentAccount(accountId, ISSCode) {
            $.ajax({
              url: 'Fetch.Validation_IntermentAccount.php',
              method: 'POST',
              data: {
                ISSCode: ISSCode
              },
              ...
              success: function(response) {
                if (response.length > 0) {
                    var data = response[0]; // Retrieve the first item in the response array
                    var LIP = data.lessIntermentPriviledge;
                    var AIP = data.addIntermentPriviledge;
                    var TIF = data.totalIntermentfee;
                   
                    // Format the list price as currency with peso sign and commas
                    var formattedLPI = new Intl.NumberFormat('en-PH', {
                        style: 'currency',
                        currency: 'PHP'
                    }).format(LIP);
                    var formattedAIP= new Intl.NumberFormat('en-PH', {
                        style: 'currency',
                        currency: 'PHP'
                    }).format(AIP);
                    var formattedTIF = new Intl.NumberFormat('en-PH', {
                        style: 'currency',
                        currency: 'PHP'
                    }).format(TIF);
                   
                    
                    var formattedLPI1 = '₱ ' + formattedLPI.substring(1);
                    var formattedAIP1 = '₱ ' + formattedAIP.substring(1);
                    var formattedTIF1 = '₱ ' + formattedTIF.substring(1);
                    
                    $('#IP').text(formattedLPI1);
                    $('#IMU').text(formattedAIP1);
                    $('#TIF').text(formattedTIF1);
                } else {
                  // Handle case when no data is returned
                }
              },
