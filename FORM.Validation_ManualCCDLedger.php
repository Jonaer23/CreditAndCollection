...
?>
    ...
    <head>
       ...
       .error {
         ...
         #notification {
            display: none;
            padding: 5px; /* Add padding to make the notification visible even without background color */
            border: 1px solid #ccc; /* Add a border for better visibility */
        }
        
        #notification.success {
         
            background-color: #E7F5E7; /* Light green background for success notifications */
            color: #4CAF50;
            font-size: 12px;
            text-align: center;
        }
        ...
        #notification.error {
            ...
            background-color: #FEE8E8; /* Light red background for error notifications */
            color: #F44336;
            font-size: 12px;
            text-align: center;
}
        ...
        div.uploadPhoto {
         ...
         .address-part {
            display: inline;
            margin-right: 10px; /* Add some spacing between address parts */
          }
        div.ChildrenTable {
            width: 100%;
            float: left;
    ...
    <body id="page-top">
                                            ...
                                            <table class="table table-bordered" width="100%"
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="table-cell" style="font-size: 14px; color: #565051; font-family: Roboto, Arial, sans-serif; padding: 5px 20px ;" ><input id="residentAddress"  style="width: 100%; background-color: transparent; border: none; color: #565051" readonly/></td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="table-cell" style="font-size: 14px; color: #565051; font-family: Roboto, Arial, sans-serif; padding: 5px 20px ;" ><input id="billingAddress" style="width: 100%; background-color: transparent; border: none; color: #565051" readonly/></td>
                                            ...
                                            <table class="table table-bordered" width="100%"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="table-cell" style="font-size: 14px; color: #ffffff; background-color: #007ea7; font-family: Roboto, Arial, sans-serif; padding: 5px 20px;" colspan="3">
                                                          CANCELLED
                                                          <button style="float: right; background: none; border: none; "  id="openModalCancelled">
                                            ...
                                            <table class="table table-bordered" width="100%"
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr hidden>
                                                        ...
                                                        <td style="font-size: 14px; color: #565051; font-family: Roboto, Arial, sans-serif; padding: 5px 20px ; width: 5%"></td>
                                                        <td style="font-size: 14px; color: #565051; font-family: Roboto, Arial, sans-serif; padding: 5px 20px ;  width: 10%"></td>
                                                        <td style="font-size: 14px; color: #565051; font-family: Roboto, Arial, sans-serif; padding: 5px 20px ; width: 25%" hidden><input id=""  style="font-size: 14px; color: #565051; font-family: Roboto, Arial, sans-serif;  width: 100%; padding: 0px 10px" readonly/></td>
                                                        <td style="width: 5%"></td>
                                                    </tr>
                                                    <tr>
                                                        <td style="font-size: 14px; color: #565051; font-family: Roboto, Arial, sans-serif; padding: 5px 20px ; width: 15%"></td>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                       ...
                                                       <td>
                                                        ...
                                                        $connection = new mysqli($host, $username1, $password, $database);
                                                        ...
                                                        // Query to fetch monthly earnings using prepared statement
                                                        $query = "SELECT paymentDueDate
                                                        ...
                                                        // Bind the parameter
                                                        $stmt->bind_param("s", $username); // Assuming userAccount is a string (change "s" if it's a different data type)
                                                        $stmt->execute();
                                                        ...
                                                        $connection->close();
                                                        ?>
                                                        <input id="matureDate" style="font-size: 14px; color: #565051; font-family: Roboto, Arial, sans-serif; width: 100%; padding: 0px 10px" value="<?= $monthlyEarnings ?>" readonly/>
                                                    </td>
                                    ...
                                    <div class="table-responsive" style="color: #4a4949">
                                        <table class="table table-bordered table-cell" id="ledgerTable"
                                            ...
                                            <thead>
                                                <tr class="header" 
                                                    style="color: #ffffff; background-color: #007ea7;font-size: 16px;padding: 5px 10px; text-align: Center">
                                                    <th scope="col" class="table-cell" colspan="14" style="padding: 5px 10px">COLLECTION</th>
                                                   
                                                </tr>
                                                <tr style="text-align: Center"><th scope="col" class="table-cell" colspan="14"><div id="notification" class="notification" style="width: 100%"></div></th></tr>
                                                ...
                                                <tr class="header" 
                                                    ...
                                                    <th scope="col" class="table-cell" style="padding: 5px 10px">ACTION</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <!-- Table rows will be dynamically populated by JavaScript -->
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                  <div style="width: 50%; float: left">
                   <label for="dateInput" style="color: #000000; margin-bottom: 20px">Select a Date:</label>
                   <label for="initialValueInput" style="color: #000000">Enter Initial Value:</label>
                   </div>
                   
                    <div style="width: 50%; float: right">
                   <input type="date" id="dateInput" style="color: #000000; margin-bottom: 20px">
                   <input type="number" id="initialValueInput">
                   </div>
        ...
        <script src="myscript/Function.ManualCCDLedger.js"></script>
        <script>
          // Function to handle saving the data from the modal
         // Get the values from the inputs
            ...
            fetch('Fetch.Validation_ManualBIS.php', {
              method: 'POST',
              headers: {
          ...
          // Add an event listener to handle the modal hidden event for settingsModal
          $('#settingsModal').on('hidden.bs.modal', function () {
            $('body').addClass('modal-open'); // Add the modal-open class back to the body
            $('.modal-backdrop').remove();
          });
        
          // Function to open the settingsModal when the button is clicked
          document.getElementById('openModalCancelled').addEventListener('click', function () {
