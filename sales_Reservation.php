...
<body id="page-top">
                        ...
                        <div class="card-body">
                            <div class="table-responsive" style="color: #4a4949 ">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    <thead>
                                        <tr class="header"
                                            style="color: #ffffff; background-color: #007ea7; font-size: 12px; padding: 5px 0px">
                                            <th scope="col" hidden></th>
                                            <th scope="col"></th>
                                            <th scope="col" class="text-xs font-weight-bold text-white text-uppercase mb-1"  style="padding: 5px 10px; font-size: 12px;">Customer Code</th>
                                            <th scope="col" class="text-xs font-weight-bold text-white text-uppercase mb-1"  style="padding: 5px 10px; font-size: 12px;">Name</th>
                                            <th scope="col" hidden>Status</th>
                                            <th scope="col" class="text-xs font-weight-bold text-white text-uppercase mb-1"  style="padding: 5px 10px; font-size: 12px;">Phone</th>
                                            <th scope="col" class="text-xs font-weight-bold text-white text-uppercase mb-1"  style="padding: 5px 10px; font-size: 12px;">Reservation Date & Time</th>
                                            <th scope="col" class="text-xs font-weight-bold text-white text-uppercase mb-1"  colspan="2" style="padding: 5px 10px; font-size: 12px;">STatus</th>
                                    ...
                                    ?>
                                        <tr style="color: #4a4949; font-size: 13px">
                                            ...
                                            <td style="border: none; text-align: center;  font-size: 13px"> 
                                                <a href="#" class="font-weight-bold text-info text-uppercase mb-1"
                                                    onclick="toggleModal(this, 1)" data-toggle="modal"
                                                    data-target=".bd-example-modal-lg2" style="padding-right: 10px;"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-eye-fill" viewBox="0 0 16 16">
                                                      <path d="M10.5 8a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0z"/>
                                                      <path d="M0 8s3-5.5 8-5.5S16 8 16 8s-3 5.5-8 5.5S0 8 0 8zm8 3.5a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7z"/>
                                                    </svg>
                                                </a> ||  
                                                <button onclick="toggleModal(this, 1)" data-toggle="modal"
                                                    data-target="#verify" class=" font-weight-bold text-success text-uppercase mb-1"
                                                    style="font-size:15px;padding-right: 10px; padding-left: 10px; background-color: transparent; border: none">
                                                ...
                                                <button class="font-weight-bold text-danger text-uppercase mb-1 delete-btn"
                                                        style="color:red; font-size:12px; padding-right: 10px; padding-left: 10px; margin:0px; border:none;background-color: transparent" >
                                            ...
                                            <td class="customerCode table-cell" name="customerCode"
                                                style="font-size: 12px;"><?=$row['customerCode']?></td>
                                            <td class="Fullname table-cell" name="Fullname" style="font-size: 12px;"><?=$row['fullname']?></td>
                                            <td class="Status table-cell" name="Status" style="font-size: 12px;" hidden><?=$row['Status']?></td>
                                            <td class="M_Phone table-cell" name="M_Phone" style="font-size: 12px;"><?=$row['Mobile_Phone']?></td>
                                            ...
                                            <td class="R_Address" name="R_Address" hidden><?=$row['r_Address']?>, <?=$row['R_Zipcode']?></td>
                                            <td class="B_Address" name="B_Address" hidden><?=$row['b_Address']?>, <?=$row['B_Zipcode']?>
                                            </td>
                                            ...
                                            <td class="Status table-cell text-success" style="font-size: 12px;" >RESERVED</td>
                            ...
                            <div class="ChildrenTable">
                                <div class="card-body">
                                    <div>
                                            ...
                                            <table class="table" cellspacing="0">
                                                <thead>
                                                    <tr style="border:none" >
                                                        <th colspan="1" style="color:#007ea7   "> Account Information</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <tr>
                                                        <td style="border: none; color:#4a4949; font-size: 13px; padding:0px 20px; margin: 0px">
                                                            CUSTOMER CODE :<p id="accountID" hidden></p> 
                                                            <input type="text" class="form-control" style="color:#4a4949; border:none;border-bottom: 1px solid; border-radius: 0px; border-radius: 0px; padding-left: 10px; background-color: transparent; width: 30%; font-size: 13px"id="CustomerCode" name="CustomerCode" readonly>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="border: none; color:#4a4949; font-size: 13px; padding:0px 20px; margin: 0px">
                                                            NAME :
                                                            <input type="text" class="form-control" style="color:#4a4949; border:none;border-bottom: 1px solid; border-radius: 0px; border-radius: 0px; padding-left: 10px; background-color: transparent; width: 30%; font-size: 13px"id="Name" name="Name" readonly>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="border: none; color:#4a4949; font-size: 13px; padding:0px 20px; margin: 0px">
                                                            EMAIL ADDRESS :
                                                            <input type="text" class="form-control" style="color:#4a4949; border:none;border-bottom: 1px solid; border-radius: 0px; border-radius: 0px; padding-left: 10px; background-color: transparent; width: 30%; font-size: 13px"id="Email" name="Email" readonly>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="border: none; color:#4a4949; font-size: 13px; padding:0px 20px; margin: 0px">
                                                            RESERVED DATE :
                                                            <input type="text" class="form-control" style="color:#4a4949; border:none;border-bottom: 1px solid; border-radius: 0px; border-radius: 0px; padding-left: 10px; background-color: transparent; width: 30%; font-size: 13px"id="Date" name="Date" readonly>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                        ...
                                        <table class="table" cellspacing="0">
                                            <tr style="border:none" >
                                                <th colspan="2" style="color:#007ea7; width: 100%">
                                                    Personal
                                                    Information</th>
                                            </tr>
                                            ...
                                            <tr>
                                                <td style="border: none; color:#4a4949; font-size: 13px; padding:0px 20px; margin: 0px">
                                                    DATE OF BIRTH :  <input type="text" class="form-control" style="color:#4a4949; border:none;border-bottom: 1px solid; border-radius: 0px; padding-left: 10px; background-color: transparent; width: 50%; font-size: 14px"id="DateBirth" name="DateBirth" readonly>
                                                </td>
                                                <td style="border: none; color:#4a4949; font-size: 13px; padding:0px 20px; margin: 0px" colspan="2">
                                                    MARITAL STATUS :  <input type="text" class="form-control" style="color:#4a4949; border:none;border-bottom: 1px solid; border-radius: 0px; padding-left: 10px; background-color: transparent; width: 50%; font-size: 14px"id="MaritalStatus" name="MaritalStatus" readonly>
                                                    
                                                </td>
                                               
                                            </tr>  
                                            <tr >
                                                <td style="border: none; color:#4a4949; font-size: 13px; padding:0px 20px;   margin: 0px; width: 50%">
                                                    BUSINESS PHONE FAX :  <input type="text" class="form-control" style="color:#4a4949; border:none;border-bottom: 1px solid; border-radius: 0px; padding-left: 10px; background-color: transparent; width: 50%; font-size: 14px"id="BusinessPhoneFax" name="BusinessPhoneFax" readonly>
                                                </td>
                                                <td style="border: none; color:#4a4949; font-size: 13px; padding:0px 20px; margin: 0px" colspan="2">
                                                    SEX :  <input type="text" class="form-control" style="color:#4a4949; border:none;border-bottom: 1px solid; border-radius: 0px; padding-left: 10px; background-color: transparent; width: 50%; font-size: 14px"id="Sex" name="Sex" readonly>
                                                </td>
                                            </tr>  
                                            <tr >
                                                <td style="border: none; color:#4a4949; font-size: 13px; padding:0px 20px; margin: 0px">
                                                    CITIZENSHIP :  <input type="text" class="form-control" style="color:#4a4949; border:none;border-bottom: 1px solid; border-radius: 0px; padding-left: 10px; background-color: transparent; width: 50%; font-size: 14px"id="Citizenship" name="Citizenship" readonly>
                                                </td>
                                                <td style="border: none; color:#4a4949; font-size: 13px; padding:0px 20px; margin: 0px; width: 30%">
                                                    WEIGHT :  <input type="text" class="form-control" style="color:#4a4949; border:none;border-bottom: 1px solid; border-radius: 0px; padding-left: 10px; background-color: transparent; width: 50%; font-size: 14px"id="Weight" name="Weight" readonly>
                                                </td>
                                                <td style="border: none; color:#4a4949; font-size: 13px; padding:0px 20px; margin: 0px">
                                                    HEIGHT :  <input type="text" class="form-control" style="color:#4a4949; border:none;border-bottom: 1px solid; border-radius: 0px; padding-left: 10px; background-color: transparent; width: 50%; font-size: 14px"id="Height" name="Height" readonly>
                                                </td>
                                            </tr> 
                                             <tr>
                                                <th colspan="3" style="color:#007ea7; width: 100%">
                                                    Contact Infomation</th>
                                            </tr>
                                             <tr >
                                                <td style="border: none; color:#4a4949; font-size: 13px; padding:0px 20px; margin: 0px;padding-right: 0px;" colspan="3">
                                                    RESIDENT ADDRESS :
                                                    <input type="text" class="form-control" style="color:#4a4949; border:none;border-bottom: 1px solid; border-radius: 0px; padding-left: 10px; background-color: transparent; width: 85%; font-size: 14px"id="ResidentAddress" name="ResidentAddress" readonly>
                                                    
                                                </td>
                                            </tr>
                                            <tr>
                                                 <td style="border: none; color:#4a4949; font-size: 13px; padding:0px 20px; margin: 0px;" colspan="3">
                                                    RESIDENTIAL PHONE # :  <input type="text" class="form-control" style="color:#4a4949; border:none;border-bottom: 1px solid; border-radius: 0px; padding-left: 10px; background-color: transparent; width: 80%; font-size: 14px"id="ResidentialPhoneno" name="ResidentialPhoneno" readonly>
                                                </td>
                                            </tr>
                                             ...
                                             <tr >
                                                <td style="border: none; color:#4a4949; font-size: 13px; padding:0px 20px; margin: 0px; padding-right: 0px;" colspan="3">
                                                    BILLING ADDRESS :
                                                    <input type="text" class="form-control" style="color:#4a4949; border:none;border-bottom: 1px solid; border-radius: 0px; padding-left: 10px; background-color: transparent; width: 85%; font-size: 14px"id="BillingAddress" name="BillingAddress" readonly>
                                                    
                                                </td>
                                            </tr>
                                            <tr>
                                                 <td style="border: none; color:#4a4949; font-size: 13px; padding:0px 20px; margin: 0px;" colspan="3">
                                                    MOBILE PHONE # :  <input type="text" class="form-control" style="color:#4a4949; border:none;border-bottom: 1px solid; border-radius: 0px; padding-left: 10px; background-color: transparent; width: 80%; font-size: 14px"id="MobilePhoneno" name="MobilePhoneno" readonly>
                                                </td>
                                            </tr>
                                        </table>
                                        <table class="table" cellspacing="0">
                                            <tr style="border:none" >
                                                <th colspan="3" style="color:#007ea7; width: 100%">
                                                   Community Tax Certificate #</th>
                                            </tr>
                                           
                                            <tr>
                                                <td style="border: none; color:#4a4949; font-size: 13px; padding:0px 20px; margin: 0px">
                                                    ISSUED AT :  <input type="text" class="form-control" style="color:#4a4949; border:none;border-bottom: 1px solid; border-radius: 0px; padding-left: 10px; background-color: transparent; width: 50%; font-size: 14px"id="IssuedAt" name="IssuedAt" readonly>
                                                </td>
                                                <td style="border: none; color:#4a4949; font-size: 13px; padding:0px 20px; margin: 0px" >
                                                    ISSUED ON :  <input type="text" class="form-control" style="color:#4a4949; border:none;border-bottom: 1px solid; border-radius: 0px; padding-left: 10px; background-color: transparent; width: 50%; font-size: 14px"id="IssuedOn" name="IssuedOn" readonly>
                                                </td>
                                               <td style="border: none; color:#4a4949; font-size: 13px; padding:0px 20px; margin: 0px" >
                                                    RESIDENCE SINCE :  <input type="text" class="form-control" style="color:#4a4949; border:none;border-bottom: 1px solid; border-radius: 0px; padding-left: 10px; background-color: transparent; width: 50%; font-size: 14px"id="ResidentSince" name="ResidentSince" readonly>
                                                </td>
                                            </tr> 
                                        </table>
                                        <table class="table" cellspacing="0">
                                            <tr style="border:none" >
                                                <th colspan="4" style="color:#007ea7; width: 100%">
                                                   Government Benefits</th>
                                            </tr>
                                           
                                            <tr>
                                                <td style="border: none; color:#4a4949; font-size: 13px; padding:0px 20px; padding-right: 0px; margin: 0px">
                                                    GSIS # :  <input type="text" class="form-control" style="color:#4a4949; border:none;border-bottom: 1px solid; border-radius: 0px; padding-left: 10px; background-color: transparent; width: 70%; font-size: 14px"id="GSIS" name="GSIS" readonly>
                                                </td>
                                                <td style="border: none; color:#4a4949; font-size: 13px; padding:0px 20px; padding-right: 0px; margin: 0px" >
                                                    HDMF # :  <input type="text" class="form-control" style="color:#4a4949; border:none;border-bottom: 1px solid; border-radius: 0px; padding-left: 10px; background-color: transparent; width: 70%; font-size: 14px"id="HDMF" name="HDMF" readonly>
                                                </td>
                                           
                                               <td style="border: none; color:#4a4949; font-size: 13px; padding:0px 20px; padding-right: 0px; margin: 0px" >
                                                    TIN # :  <input type="text" class="form-control" style="color:#4a4949; border:none;border-bottom: 1px solid; border-radius: 0px; padding-left: 10px; background-color: transparent; width: 70%; font-size: 14px"id="TIN" name="TIN" readonly>
                                                </td>
                                               <td style="border: none; color:#4a4949; font-size: 13px; padding:0px 20px; padding-right: 0px; margin: 0px" >
                                                    NBI # :  <input type="text" class="form-control" style="color:#4a4949; border:none;border-bottom: 1px solid; border-radius: 0px; padding-left: 10px; background-color: transparent; width: 70%; font-size: 14px"id="NBI" name="NBI" readonly>
                                                </td>
                                            </tr> 
                                        </table>
                                        <table class="table" cellspacing="0">
                                            ...
                                            <tr>
                                                <td style="border: none; color:#4a4949; font-size: 13px; padding:0px 20px; padding-right: 0px; margin: 0px">
                                                    MOTHER'S NAME :  <input type="text" class="form-control" style="color:#4a4949; border:none;border-bottom: 1px solid; border-radius: 0px; padding-left: 10px; background-color: transparent; width: 70%; font-size: 14px"id="MotherName" name="MotherName" readonly>
                                                </td>
                                                <td style="border: none; color:#4a4949; font-size: 13px; padding:0px 20px; padding-right: 0px; margin: 0px" >
                                                    OCCUPATION :  <input type="text" class="form-control" style="color:#4a4949; border:none;border-bottom: 1px solid; border-radius: 0px; padding-left: 10px; background-color: transparent; width: 70%; font-size: 14px"id="MotherOccupation" name="MotherOccupation" readonly>
                                                </td>
                                            </tr> 
                                            <tr>
                                                <td style="border: none; color:#4a4949; font-size: 13px; padding:0px 20px; padding-right: 0px; margin: 0px">
                                                    FATHER'S NAME :  <input type="text" class="form-control" style="color:#4a4949; border:none;border-bottom: 1px solid; border-radius: 0px; padding-left: 10px; background-color: transparent; width: 70%; font-size: 14px"id="FatherName" name="FatherName" readonly>
                                                </td>
                                                <td style="border: none; color:#4a4949; font-size: 13px; padding:0px 20px; padding-right: 0px; margin: 0px" >
                                                    OCCUPATION :  <input type="text" class="form-control" style="color:#4a4949; border:none;border-bottom: 1px solid; border-radius: 0px; padding-left: 10px; background-color: transparent; width: 70%; font-size: 14px"id="FatherOccupation" name="FatherOccupation" readonly>
                                                </td>
                                            </tr> 
                                            <tr>
                                                <td style="border: none; color:#4a4949; font-size: 13px; padding:0px 20px; padding-right: 0px; margin: 0px">
                                                    SPOUSE NAME :  <input type="text" class="form-control" style="color:#4a4949; border:none;border-bottom: 1px solid; border-radius: 0px; padding-left: 10px; background-color: transparent; width: 70%; font-size: 14px"id="SpouseName" name="SpouseName" readonly>
                                                </td>
                                                <td style="border: none; color:#4a4949; font-size: 13px; padding:0px 20px; padding-right: 0px; margin: 0px" >
                                                    OCCUPATION :  <input type="text" class="form-control" style="color:#4a4949; border:none;border-bottom: 1px solid; border-radius: 0px; padding-left: 10px; background-color: transparent; width: 70%; font-size: 14px"id="SpouseOccupation" name="SpouseOccupation" readonly>
                                                </td>
                                            </tr> 
                                            <tr>
                                                <td style="border: none; color:#4a4949; font-size: 13px; padding:10px 50px; padding-right: 0px; margin: 0px" colspan="2">
                                                    CHILDREN'S NAME :  <textarea rows="4" cols="50" class="form-control" style="color:#4a4949; float:right; border-radius: 0px; padding-left: 10px; background-color: transparent; width: 85%; font-size: 14px"id="ChildrenName" name="ChildrenName" readonly> </textarea>
                                                </td>
                                            </tr> 
                                        </table>
                                        ...
                                        <table class="table" cellspacing="0">
                                            ...
                                            <tr>
                                                <td style="border: none; color:#4a4949; font-size: 13px; padding:0px 20px; padding-right: 0px; margin: 0px">
                                                    EMPLOYMENT STATUS :  <input type="text" class="form-control" style="color:#4a4949; border:none;border-bottom: 1px solid; border-radius: 0px; padding-left: 10px; background-color: transparent; width: 70%; font-size: 14px"id="Employment" name="Employment" readonly>
                                                </td>
                                                <td style="border: none; color:#4a4949; font-size: 13px; padding:0px 20px; padding-right: 0px; margin: 0px" >
                                                    POSITION IN COMPANY :  <input type="text" class="form-control" style="color:#4a4949; border:none;border-bottom: 1px solid; border-radius: 0px; padding-left: 10px; background-color: transparent; width: 70%; font-size: 14px"id="PositionCompany" name="PositionCompany" readonly>
                                                </td>
                                            </tr> 
                                            <tr>
                                                <td style="border: none; color:#4a4949; font-size: 13px; padding:0px 20px; padding-right: 0px; margin: 0px">
                                                    SOURCE OF INCOME :  <input type="text" class="form-control" style="color:#4a4949; border:none;border-bottom: 1px solid; border-radius: 0px; padding-left: 10px; background-color: transparent; width: 70%; font-size: 14px"id="Source" name="Source" readonly>
                                                </td>
                                                <td style="border: none; color:#4a4949; font-size: 13px; padding:0px 20px; padding-right: 0px; margin: 0px" >
                                                    PERSONAL MONTHLY INCOME :  <input type="text" class="form-control" style="color:#4a4949; border:none;border-bottom: 1px solid; border-radius: 0px; padding-left: 10px; background-color: transparent; width: 70%; font-size: 14px"id="PersonalMonthlyIncome" name="PersonalMonthlyIncome" readonly>
                                                </td>
                                            </tr> 
                                            <tr>
                                                <td style="border: none; color:#4a4949; font-size: 13px; padding:0px 20px; padding-right: 0px; margin: 0px">
                                                    EMPLOYER OR BUSINESS NAME (IF SELF-EMPLOYED) :  <input type="text" class="form-control" style="color:#4a4949; border:none;border-bottom: 1px solid; border-radius: 0px; padding-left: 10px; background-color: transparent; width: 70%; font-size: 14px"id="Employer" name="Employer" readonly>
                                                </td>
                                                <td style="border: none; color:#4a4949; font-size: 13px; padding:0px 20px; padding-right: 0px; margin: 0px" >
                                                    EMPLOYMENT DATE/DATE WHEN BUSINESS WAS ESTABLISHED :  <input type="text" class="form-control" style="color:#4a4949; border:none;border-bottom: 1px solid; border-radius: 0px; padding-left: 10px; background-color: transparent; width: 70%; font-size: 14px"id="EmploymentbusinessEstablished" name="EmploymentbusinessEstablished" readonly>
                                                </td>
                                            </tr> 
                                            <tr>
                                                <td style="border: none; color:#4a4949; font-size: 13px; padding:0px 20px; padding-right: 0px; margin: 0px">
                                                   NATURE OF EMPLOYER'S BUSINESS / YOUR BUSINESS :  <input type="text" class="form-control" style="color:#4a4949; border:none;border-bottom: 1px solid; border-radius: 0px; padding-left: 10px; background-color: transparent; width: 70%; font-size: 14px"id="Nature" name="Nature" readonly>
                                                </td>
                                            </tr> 
                                        </table>
                                    </div>
    ...
    <div class="modal fade bd-example-modal-lg1" id="verify" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <div class="ChildrenTable">
                    <div style="font-size: 12px; padding: 8px; color:#4a4949">
                    ...
                    <form id="ledger">
                        <div class="card-body" style="color:#4a4949; " id="showlotdiv">
                                ...
                                <table id="dtlotDescRecord" class="table table-striped table-bordered table-sm"
                                    ...
                                    <thead>
                                        ...
                                        <tr style="background-color: #00a8e8">
                                            <th class="th-sm" style="font-size: 12px; color:#ffffff " hidden>ID</th>
                                            <th class="th-sm font-weight-normal text-uppercase mb-1 text-white" style="font-size: 12px; color:#ffffff ">Lot Id</th>
                                            <th class="th-sm font-weight-normal text-uppercase mb-1 text-white" style="font-size: 12px; color:#ffffff ">Section</th>
                                            <th class="th-sm font-weight-normal text-uppercase mb-1 text-white" style="font-size: 12px; color:#ffffff ">Lot No.</th>
                                            <th class="th-sm font-weight-normal text-uppercase mb-1 text-white" style="font-size: 12px; color:#ffffff ">Area</th>
                                            <th class="th-sm font-weight-normal text-uppercase mb-1 text-white" style=" font-size: 12px; color:#ffffff ">Phase</th>
                                            <th class="th-sm font-weight-normal text-uppercase mb-1 text-white" style=" font-size: 12px; color:#ffffff ">Type
                                            </th>
                                            <th class="th-sm font-weight-normal text-uppercase mb-1 text-white" style=" font-size: 12px; color:#ffffff ">Classification
                                            </th>
                                            <th class="th-sm font-weight-normal text-uppercase mb-1 text-white" style="font-size: 12px; color:#ffffff ">List Price
                                            </th>
                                            <th class="th-sm font-weight-normal text-uppercase mb-1 text-white" style="font-size: 12px; color:#ffffff ">Tools</th>
                                            </th>
                                        </tr>
                                    </thead>
                                   ...
                                   <tbody style="border: 2px solid #e3e6f0;">
                                      <?php
                                      $sales_query = "SELECT id, block, section, lot_no, area, phase, type,classification, ListPrice FROM tbl_lotdescription WHERE status = 'Available'";
                                      ...
                                      ?>
                                            <tr style="border: 2px solid #e3e6f0">
                                              <td style="font-size: 12px; color:#4a4949" class="lot_id table-cell m-0 font-weight-normal text-uppercase mb-1 text-gray-800" hidden><?= htmlspecialchars($row['id']) ?></td>
                                              <td style="font-size: 12px; color:#4a4949" class="lot_block table-cell m-0 font-weight-normal text-uppercase mb-1 text-gray-800"><?= htmlspecialchars($row['block']) ?></td>
                                              <td style="font-size: 12px; color:#4a4949" class="lot_section table-cell m-0 font-weight-normal text-uppercase mb-1 text-gray-800"><?= htmlspecialchars($row['section']) ?></td>
                                              <td style="font-size: 12px; color:#4a4949" class="lot_no table-cell m-0 font-weight-normal text-uppercase mb-1 text-gray-800"><?= htmlspecialchars($row['lot_no']) ?></td>
                                              <td style="font-size: 12px; color:#4a4949" class="lot_area table-cell m-0 font-weight-normal text-uppercase mb-1 text-gray-800"><?= htmlspecialchars($row['area']) ?></td>
                                              <td style="font-size: 12px; color:#4a4949" class="lot_phase table-cell m-0 font-weight-normal text-uppercase mb-1 text-gray-800"><?= htmlspecialchars($row['phase']) ?></td>
                                              <td style="font-size: 12px; color:#4a4949" class="lot_type table-cell m-0 font-weight-normal text-uppercase mb-1 text-gray-800"><?= htmlspecialchars($row['type']) ?></td>
                                              <td style="font-size: 12px; color:#4a4949" class="lot_classification table-cell m-0 font-weight-normal text-uppercase mb-1 text-gray-800"><?= htmlspecialchars($row['classification']) ?></td>
                                              <td style="font-size: 12px; color:#4a4949" class="lot_TCP table-cell m-0 font-weight-normal text-uppercase mb-1 text-gray-800"><?= '₱ ' . number_format($row['ListPrice'], 2, '.', ',') ?></td>
                                    
                                              <td style="font-size: 12px; color:#4a4949" class="table-cell">
                            ...
                            <div style=" width: 100%; text-align: left; ">
                                <div
                                    style="float: left; width: 40%; height: 500px; padding: 40px 10px; margin-bottom: 5px; color:#4a4949; font-size: 12px; font-weight: bold;background-color: #fcd8b6;">
                                    <table style="width:100%; color:#4a4949; font-size: 12px; font-weight: bold;">
                                        <tr>
                                            <td style="width:40%">Customer Name:</td>
                                            <td><input type="text" id="Fullname1" name="Fullname1"
                                                    style="color:#4a4949;border:none; background-color: transparent;padding:2px; font-size: 12px;"
                                                    readonly></td>
                                        ...
                                        <tr>
                                            ...
                                            <input type="text" id="id1" name="id1" class="form-control"
                                                style="color:#4a4949;border:none; width: 95%;background-color: transparent; padding-left: 30px; font-size: 12px;"
                                                hidden readonly>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text"
                                                    style="color:#4a4949;border:none; background-color: transparent;padding:2px; font-size: 12px;"
                                                    id="lot_classification1" name="lot_classification1" readonly></td>
                                        </tr>
                                    </table>
                                </div>
                                <div
                                    style="float: right; width: 60%; height: 500px; margin-bottom: 30px;  padding: 40px 10px;  color:#4a4949; font-size: 12px; font-weight: bold;background-color: #fcd8b6;">
                                           ...
                                           <tr style="border: none">
                                              <td style="border: none; background-color: #5B7EDE; font-size: 13px; color:white; padding:2px 15px; margin:2px; font-weight: bold;">
                                                Perpetual Care Funds :
                                                    ...
                                                    <td style="border: none; background-color: #5B7EDE; color:#4a4949; padding:2px 15px; margin:2px;">
                                                      <input placeholder="₱ 0.00" readonly pattern="^₱\d{1,3}(,\d{3})*(\.\d+)?₱" data-type="currency" style="padding:2px 15px; width:  95%; font-size: 13px; margin:2px; background-color: #e8e4c9 ; border: none; color:#4a4949; width: 95%" id="pcf" name="pcf"></input>
                                                      <input placeholder="₱ 0.00" hidden readonly style="padding:2px 15px; width:  95%; font-size: 13px; margin:2px; background-color: #e8e4c9 ; border: none; color:#4a4949; width: 95%" id="pcf1" name="pcf1" value="'₱ 40,000'"></input>
                            ...
                            <table class="table " cellspacing="0">
                                <th colspan="5" style="color:#ffffff; background-color:#007ea7; font-size: 12px;">
                                    Where did you find Southspring?
                                </th>
                                <tr style="color:#4a4949">
                                    <td>
                                        <p style="font-size: 12px;">Please select one of the following options: agent,
                                            website, social media, or walk-in.</p>
                                        <select required class="form-control" id="marketAnalysis" name="marketAnalysis"
                                            style="color:#4a4949; width: 100%; font-size: 12px;"><br>
                                    ...
                                    <td>
                                        <p style="font-size: 12px;">Agent name</p>
                            ...
                            <table class="table " cellspacing="0">
                                ...
                                <tr style="color:#4a4949">
                                    <td>Initial Payment<br><input type="date" required class="form-control"
                                                               ...
                                                               style="color:#4a4949; font-size: 12px; margin-top: 7px" 
                                                               min="<?php echo date('Y-m-d', strtotime('+1 day')); ?>"
                                                               value="<?php echo date('Y-m-d', strtotime('+1 day')); ?>"
                                                               onchange="setMinDate()" onfocus="this.blur()">
                                    </td>
                                    <td>Payment Method<br>
                                        <select class="form-control" id="paymentMethod" required name="paymentMethod"
                                            style="color:#4a4949; width: 95%; font-size: 12px;"><br>
                                    ...
                                    <td>Full downpayment<br><input readonly type="text" required class="form-control"
                                            ...
                                            style="color:#4a4949; font-size: 12px;">
                                    </td>
                                </tr>
                            </table>
                            ...
                            <div style="float:right; margin-bottom:10px;">
                                <button type="button" data-toggle="modal" data-target="#lotvouchercodeModal"
                                    ...
                                    voucher</button>
                                <button type="button" name="lotLedger1" id="lotLedger1"
                        ...
                        <div class="card-body" style="color:#4a4949; display:none" id="showcryptdiv">
                            <div class="table-responsive" style="width: 100%;" id="showcryptdescdiv">
                               <table id="dtcryptDescRecord" class="table table-striped table-bordered table-sm" style="color:#4a4949" cellspacing="0" width="100%">
                                  <thead>
                                    <tr style="background-color: #00a8e8">
                                      <th class="th-sm" style="width: 2%; font-size: 12px; color:#ffffff">ID</th>
                                      <th class="th-sm" style="width: 10%; font-size: 12px; color:#ffffff">Phase</th>
                                      <th class="th-sm" style="width: 10%; font-size: 12px; color:#ffffff">Level</th>
                                      <th class="th-sm" style="width: 10%; font-size: 12px; color:#ffffff">Area</th>
                                      <th class="th-sm" style="width: 10%; font-size: 12px; color:#ffffff">Section</th>
                                      <th class="th-sm" style="width: 10%; font-size: 12px; color:#ffffff">Column</th>
                                      <th class="th-sm" style="width: 10%; font-size: 12px; color:#ffffff">Unit no</th>
                                      <th class="th-sm" style="width: 10%; font-size: 12px; color:#ffffff">Classification</th>
                                      <th class="th-sm" style="width: 10%; font-size: 12px; color:#ffffff">List Price</th>
                                      <th class="th-sm" style="width: 6%; font-size: 12px; color:#ffffff">Tools</th>
                                    </tr>
                                  </thead>
                                  <tbody style="border: 2px solid #e3e6f0;">
                                    <?php
                                    ...
                                    ?>
                                        <tr style="border: 2px solid #e3e6f0">
                                          <td style="width: 2%; font-size: 12px; color:#4a4949" class="table-cell"><?= htmlspecialchars($row['id']) ?></td>
                                          <td style="width: 10%; font-size: 12px; color:#4a4949" class="table-cell"><?= htmlspecialchars($row['phase']) ?></td>
                                          <td style="width: 10%; font-size: 12px; color:#4a4949" class="table-cell"><?= htmlspecialchars($row['level']) ?></td>
                                          <td style="width: 10%; font-size: 12px; color:#4a4949" class="table-cell"><?= htmlspecialchars($row['area']) ?></td>
                                          <td style="width: 10%; font-size: 12px; color:#4a4949" class="table-cell"><?= htmlspecialchars($row['section']) ?></td>
                                          <td style="width: 10%; font-size: 12px; color:#4a4949" class="table-cell"><?= htmlspecialchars($row['crypt_column']) ?></td>
                                          <td style="width: 10%; font-size: 12px; color:#4a4949" class="table-cell"><?= htmlspecialchars($row['unit_no']) ?></td>
                                          <td style="width: 10%; font-size: 12px; color:#4a4949" class="table-cell"><?= htmlspecialchars($row['classification']) ?></td>
                                          <td style="width: 10%; font-size: 12px; color:#4a4949" class="table-cell"><?= '₱ ' . number_format($row['listPrice'], 2, '.', ',') ?></td>
                                          <td style="width: 6%; font-size: 12px; color:#4a4949" class="table-cell">
                            ...
                            <div id="printmycryptDiv">
                                <div style=" width: 100%; text-align: left; ">
                                    <div
                                        style="float: left; width: 40%; height: 500px; padding: 40px 10px; margin-bottom: 30px; color:#4a4949; font-size: 12px; font-weight: bold;background-color: #fcd8b6;">
                                        <table style="width:100%; color:#4a4949; font-size: 12px; font-weight: bold;">

                                            <tr>
                                                <td style="width:50%; text-align: left">Accredited Date : </td>
                                                <td style="width:50%;"><input type="text" id="date23" name="date23"
                                                        style="width: 90%;  text-align: left;  pointer-events: none; color:#4a4949;border:none; background-color: transparent;padding:2px; font-size: 12px;"
                                                        readonly></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td style="width:50%;"><input type="text"
                                                        style="width: 90%; text-align: left; color:#4a4949;border:none; pointer-events: none; background-color: transparent;padding:2px; font-size: 12px;"
                                            ...
                                            <tr>
                                                ...
                                                <td style="width:50%;"><input type="text"
                                                        style="width: 90%; text-align: left;color:#4a4949;border:none; background-color: transparent;padding:2px; font-size: 12px;"
                                    ...
                                    <div style="float: right; width: 60%; height: 500px; margin-bottom: 30px;  padding: 40px 10px;  color:#4a4949; font-size: 12px; font-weight: bold;background-color: #fcd8b6;">
                                        <div style="width: 100%;  border-color: #5B7EDE">
                                            <table class="table" cellspacing="0">
                                                <tr style="border: none;">
                                                    <td
                                    ...
                                    <table class="table " cellspacing="0">
                                        <th colspan="5"
                                            style="color:#ffffff; background-color:#007ea7; font-size: 12px;">
                                            Where did you find Southspring?
                                        </th>
                                        <tr style="color:#4a4949">
                                            <td>
                                                <p style="font-size: 12px;">Please select one of the following options:
                                            ...
                                            <td>
                                                ...
                                                <input class="form-control" id="cryptagentName" name="cryptagentName"
                                                    style="color:#4a4949; width: 100%; font-size: 12px;" required /><br>
                                            </td>
                                        </tr>
                                    </table>
                                    <table class="table " cellspacing="0">
                                        ...
                                        <tr style="color:#4a4949">
                                            <td>Initial Payment<br><input type="date" class="form-control"
                                                    ...
                                                    style="color:#4a4949; font-size: 12px; margin-top: 7px" required>
                                            <td>
                                                Payment Method<br>
                                                <select class="form-control" required id="cryptpaymentMethod"
                                                    name="cryptpaymentMethod"
                                                    style="color:#4a4949; background-color:#f7efe4;width: 95%; font-size: 12px; background-color: #f5ebe1;"><br>
                                                    <option value="">------Select Payment Method------</option>
                                            ...
                                            <td>Full Downpayment<br><input readonly type="text" class="form-control"
                                                    ...
                                                    style="color:#4a4949; font-size: 12px;" required>
                                            </td>
                                        </tr>
                                    </table>
                                </div>
                            ...
                            <div style="float:right; margin-bottom:10px;">
                                ...
                                <button type="button" name="cryptbtnLedger" id="cryptbtnLedger"
                                    class="save-button">Save</button>
                            </div>
                        </div>
                    </form>
                    ...
                    <table class="table " cellspacing="0">
                        ...
                        <tr style="color:#4a4949">
                            <td>Voucher code: <br><input type="text" class="form-control" id="cryptvouchercode"
                                    name="cryptvouchercode" style="color:#4a4949; font-size: 12px; margin-top: 7px">
                    ...
                    <table class="table " cellspacing="0">
                        ...
                        <tr style="color:#4a4949">
                            <td>Voucher code: <br><input type="text" class="form-control" id="lotvouchercode"
                                    name="lotvouchercode" style="color:#4a4949; font-size: 12px; margin-top: 7px" />
    ...
    $(document).ready(function() {
        $('#dtlotDescRecord').DataTable({
            columnDefs: [
                {
                    targets: [8], // Index of the column you want to exclude from search (0-based index)
                    searchable: false
                }
            ],
            language: {
                search: "_INPUT_", // Placeholder for the search input field
                searchPlaceholder: "Search ...." // Your desired placeholder text
            }
        });
    ...
    for (var i = 1; i < table.rows.length; i++) {
        table.rows[i].onclick = function() {
            ...
            document.getElementById("lot_classification1").value = this.cells[7].innerHTML;
            document.getElementById("lotListPrice").value = this.cells[8].innerHTML;
...
<script>
        $(document).ready(function() {
            $("#lotLedger1").click(function() {
                var Fullname1 = $("#Fullname1").val();
                var customerCode1 = $("#customerCode1").val();
                var date1 = $("#date1").val();
                var lot_id1 = $("#lot_id1").val();
                var lot_block1 = $("#lot_block1").val();
                var lot_section1 = $("#lot_section1").val();
                var lot_no1 = $("#lot_no1").val();
                var lot_area1 = $("#lot_area1").val();
                var lot_phase1 = $("#lot_phase1").val();
                var lot_type1 = $("#lot_type1").val();
                var terms = $("#terms").val();
                var lotListPrice = $("#lotListPrice").val();
                var taxs1 = $("#taxs1").val();
                var subtotaltax = $("#subtotaltax").val();
                var discounts1 = $("#discounts1").val();
                var subtotalDiscount = $("#subtotalDiscount").val();
                var pcf = $("#pcf").val();
                var totalContractPrice3 = $("#totalContractPrice3").val();
                var dpPercentage2 = $("#dpPercentage2").val();
                var dpPercentage = $("#dpPercentage").val();
                var balance = $("#balance").val();
                var MI1 = $("#MI1").val();
                var MI2 = $("#MI2").val();
                var factorratePercentage = $("#factorratePercentage").val();
                var factorrate = $("#factorrate").val();
                var NoOfMonths = $("#NoOfMonths").val();
                var PaymentDueDate = $("#PaymentDueDate").val();
                var paymentMethod = $("#paymentMethod").val();
                var user = $("#user").val();
                var marketAnalysis = $("#marketAnalysis").val();
                var Email1 = $("#Email1").val();
                var agentName = $("#agentName").val();
                var lot_classification1 = $("#lot_classification1").val();
        
                $.ajax({
                    url: "sales_InsertData.php",
                    type: "POST",
                    data: { 
                        Fullname1: Fullname1, 
                        ...
                        date1: date1, 
                        lot_id1: lot_id1, 
                        lot_block1: lot_block1, 
                        lot_section1: lot_section1, 
                        lot_no1: lot_no1, 
                        lot_area1: lot_area1, 
                        lot_phase1: lot_phase1, 
                        lot_type1: lot_type1, 
                        terms: terms, 
                        ...
                        pcf: pcf, 
                        totalContractPrice3: totalContractPrice3, 
                        dpPercentage2: dpPercentage2, 
                        dpPercentage: dpPercentage, 
                        balance: balance, 
                        MI1: MI1, 
                        MI2: MI2, 
                        factorratePercentage: factorratePercentage, 
                        ...
                        Email1: Email1, 
                        agentName: agentName, 
                        lot_classification1: lot_classification1
                        },
                    success: function(response) {
                        $("#ledger")[0].reset(); // Clear the form
...
<script>
        $(document).ready(function() {
            $("#cryptbtnLedger").click(function() {
                var Fullname2 = $("#Fullname2").val();
                var CustomerCode123 = $("#CustomerCode123").val();
                var date23 = $("#date23").val();
                var crypt_id1 = $("#crypt_id1").val();
                var cryptphase = $("#cryptphase").val();
                var cryptlevel = $("#cryptlevel").val();
                var cryptArea = $("#cryptArea").val();
                var cryptSection = $("#cryptSection").val();
                var cryptLotNo = $("#cryptLotNo").val();
                var cryptColumn = $("#cryptColumn").val();
                var cryptUnit = $("#cryptUnit").val();
                var cryptClassification = $("#cryptClassification").val();
                var cryptterms = $("#cryptterms").val();
                var cryptlotListPrice = $("#cryptlotListPrice").val();
                var crypttaxs1 = $("#crypttaxs1").val();
                var cryptsubtotaltax = $("#cryptsubtotaltax").val();
                var cryptdiscounts1 = $("#cryptdiscounts1").val();
                var cryptsubtotalDiscount = $("#cryptsubtotalDiscount").val();
                var cryptpcf = $("#cryptpcf").val();
                var crypttotalContractPrice3 = $("#crypttotalContractPrice3").val();
                var cryptdpPercentage2 = $("#cryptdpPercentage2").val();
                var cryptdpPercentage = $("#cryptdpPercentage").val();
                var cryptbalance = $("#cryptbalance").val();
                var cryptMI1 = $("#cryptMI1").val();
                var cryptMI2 = $("#cryptMI2").val();
                var cryptfactorratePercentage = $("#cryptfactorratePercentage").val();
                var cryptfactorrate = $("#cryptfactorrate").val();
                var cryptNoOfMonths = $("#cryptNoOfMonths").val();
                var cryptPaymentDueDate = $("#cryptPaymentDueDate").val();
                var cryptpaymentMethod = $("#cryptpaymentMethod").val();
                var user = $("#user").val();
                var cryptmarketAnalysis = $("#cryptmarketAnalysis").val();
                var cryptEmail1 = $("#cryptEmail1").val();
        
                $.ajax({
                    url: "FETCH.Validation_SalesReserved.php",
                    type: "POST",
                    data: { 
                        Fullname2: Fullname2, 
                        CustomerCode123: CustomerCode123, 
                        date23: date23, 
                        crypt_id1: crypt_id1, 
                        ...
                        cryptLotNo: cryptLotNo, 
                        cryptColumn: cryptColumn, 
                        cryptUnit: cryptUnit, 
                        cryptClassification: cryptClassification, 
                        cryptterms: cryptterms, 
                        cryptlotListPrice: cryptlotListPrice, 
                        crypttaxs1: crypttaxs1, 
                        cryptsubtotaltax: cryptsubtotaltax, 
                        cryptdiscounts1: cryptdiscounts1, 
                        cryptsubtotalDiscount: cryptsubtotalDiscount, 
                        cryptpcf: cryptpcf, 
                        crypttotalContractPrice3: crypttotalContractPrice3, 
                        cryptdpPercentage2: cryptdpPercentage2, 
                        cryptdpPercentage: cryptdpPercentage, 
                        cryptbalance: cryptbalance, 
                        cryptMI1: cryptMI1, 
                        cryptMI2: cryptMI2, 
                        cryptfactorratePercentage: cryptfactorratePercentage, 
                        cryptfactorrate: cryptfactorrate, 
                        cryptNoOfMonths: cryptNoOfMonths, 
                        cryptPaymentDueDate: cryptPaymentDueDate, 
                        cryptpaymentMethod: cryptpaymentMethod, 
                        user: user, 
                        cryptmarketAnalysis: cryptmarketAnalysis, 
                        cryptEmail1: cryptEmail1
                        },
                    success: function(response) {
                        $("#cryptledger")[0].reset(); // Clear the form
                         location.reload(); // Refresh the page
                    },
                    error: function(xhr, status, error) {
                        console.log("AJAX Error:", status, error);
    ...
    <script>
        function setMinDate() {
            ...
            document.getElementById("PaymentDueDate").min = minDate;
        }
