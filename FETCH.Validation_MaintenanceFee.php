...
$query = "SELECT 
    SUM(fi.amountReceived) AS totalSales
FROM 
    tbl_ledger AS l
INNER JOIN 
    tbl_certificateofownership AS fi ON l.customerCode = fi.userAccount
WHERE
    fi.remarks = 'Paid' AND
    fi.dateCreated BETWEEN '$fromDate' AND DATE_ADD('$toDate', INTERVAL 1 DAY);";
