...
<body id="page-top">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <input type="text" id="accountUser" value="<?php echo $Name; ?>" hidden/>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3" style="background-color: #003459;">
                            ...
                            <button class="btn btn-primary custom-button" Style="float: Right;" data-toggle="modal" data-target="#viewHistory">
                        ...
                        <div class="card-body">
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    <thead>
                                        <tr class="header"
                                            ...
                                            <th class="table-cell" scope="col">Requested By</th>
                            ...
                            <div style="width:100%;">
                                ...
                                <div style=" float:right; width:33%;">
                                    <button style="float:right;" class="btn green-button" data-toggle="modal"
                                        data-target="#myModal">Create Request</button>
                                </div>

                                <div style=" float:left;  width:34%">
                                    <button style="float:left" class="btn grey-button" data-toggle="modal"
                                        data-target="#Liquidate">Liquidate</button>
                                </div>

                                <div style="float:left;width:33%;">
                                    <button class="btn grey-button" data-toggle="modal" data-target="#viewRequest">View
                                        Request</button>
                                </div>
                            </div>
                        </div>
                ...
                <form id="createrequest">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group" style=" color: #000000">
                            ...
                            <input type="text" style=" color: #000000" class="form-control" id="requestBy">
                        </div>
                        <div class="form-group" style=" color: #000000">
                            <label for="">Department:</label>
                            <input type="text" style=" color: #000000" class="form-control" id="department">
                        </div>
                        <div class="form-group" style=" color: #000000">
 ...
 <!-- view History modal-->
    ...
    <script src="myscript/Function.Fetch_PurchaseRequest.js"></script>
    <script src="myscript/Function.PurchaseRequest.js"></script>
    <script src="myscript/Function.fetch_ViewHistory.js"></script>
    <style>
