              ...
              const desiredIntermentDisplay = $("#desiredInterment-display");
                ...
                if (holiday) {
                    ...
                    if (
                      ...
                      desiredIntermentDisplay.text("SPECIAL DAY (WEEKDAYS) NIGHT/DAWN (6:00 P.M. - 8:30 A.M.)");
                    } else {
                        
                      desiredIntermentDisplay.text("SPECIAL DAY (WEEKDAYS)");
                    }
...
<body id="page-top">
                        ...
                        <div class="card shadow mb-4 text-uppercase mb-1"  style="color: #333; font-size: 12px; padding: 20px 20px;"  >
                            ...
                            <div style=" justify-content: space-between; padding: 10px;">
                                ...
                                <table style="width: 50%; float: left">
                                    <tbody>
                                        <tr>
                                            <td><span><p class="text-gray-900 text-uppercase mb-1" style="font-size: 12px">No. of days penalties : </p></span></td>
                                            <td style="border-bottom: 1px solid; padding-right: 5px"><span><p class="text-gray-900 text-uppercase mb-1" style="font-size: 12px; text-align: right" id="noMonthspenalty"></p></span></td>
                                        </tr>
                                        <tr>
                                            <td><span><p class="text-gray-900 text-uppercase mb-1" style="font-size: 12px">No. of frequency requests : </p></span></td>
                                            <td style="border-bottom: 1px solid; padding-right: 5px"><span><p class="text-gray-900 text-uppercase mb-1" style="font-size: 12px; text-align: right" id="frequencyrequest"></p></span></td>
                                        </tr>
                                        <tr>
                                            <td><span><p class="text-gray-900 text-uppercase mb-1" style="font-size: 12px">Penalty amount : </p></span></td>
                                            <td style="border-bottom: 1px solid; padding-right: 5px"><span><p class="text-gray-900 text-uppercase mb-1" style="font-size: 12px; text-align: right" id="penaltyamount"></p></span></td>
                                        </tr>
                                        <tr>
                                            <td><span><p class="text-gray-900 text-uppercase mb-1" style="font-size: 12px">reinstatement fee : </p></span></td>
                                            <td style="border-bottom: 1px solid; padding-right: 5px; padding-top: 5px"><span><p class="text-gray-900 text-uppercase mb-1" style="font-size: 12px; text-align: right" id="reinstatementfee"></p></span></td>
                                        </tr>
                                        <tr>
                                            <td><span><p class="text-gray-900 text-uppercase mb-1 font-weight-bold" style="font-size: 12px">total amount paid : </p></span></td>
                                            <td style="border-bottom: 1px solid; padding-right: 5px; padding-top: 5px"><span><p class="text-gray-900 text-uppercase mb-1 font-weight-bold" style="font-size: 12px; text-align: right" id="amountPaid1"></p></span></td>
                                        </tr>
                                        <tr >
                                            <td ><button  class="btn btn-success" style="font-size: 12px; margin-top: 30px; display: none; width: 100%" id="computebtn" onclick="computeIntermentFee()">COMPUTE REINSTATEMENT  FEE</button></td>
                                            <td  style="padding-left: 10px"><button onclick="toggleDivVisibility()"  class="btn btn-info" style="font-size: 12px; margin-top: 30px; width: 100%" id="downloadblebtn">REINSTATEMENT  REQUEST</button></td>
                                        </tr>
                                        </tbody>
                                </table>
                            ...
                            <div style="justify-content: space-between; font-size: 12px; padding: 20px 20px; margin-top: 50px; width: 100%; float: left; border: 1px solid #f5f5f5; box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3); display: none;" id="downloadbleform" >
                                    <table style="margin-bottom: 30px; width: 100%; float: left">
                                        <thead>
                                            <th>
                                                <span><p style="font-size: 16px">REINSTATEMENT  INFORMATION</p></span>
                                                <div id="result"></div>
                                            </th>
                                        </thead>
                                        <tbody>
                                    ...
                                    <table class="table table-bordered" style="border:none; width: 100%;color: #333;"
                                                cellspacing="0" id="disInterment" hidden>
                                       <thead>
                                            <tr class="text-xs font-weight-bold text-uppercase mb-1"
                                            style="color: #ffffff; background-color: #007ea7; font-size: 14px">
                                    ...
                                    <table style="width:100%" class="table">
                                        <thead>
                                            <tr style="width: 30%;">
                                                <th scope="col" class="text-xs font-weight-bold text-uppercase mb-1"  style="background-color: #007ea7; color: white; padding:  5px 20px;  " colspan="4"><span><p style="font-size: 12px; margin: 0px;">PAYMENT DATE</p></span></th>
                                            </tr>
                                       ...
                                       <tbody>
                                            <tr>
                                                <td scope="col" class="text-xs font-weight-bold text-uppercase mb-1 text-gray-900"  style="padding-left: 20px; width: 30%; " >
                                                    <span>
                                                      <p style="font-size: 12px; padding-top: 10px; padding-bottom: 10px; margin: 0;  ">PAYMENT DUE DATE  ?</p>
                                                    </span>
                                                </td>
                                                
                                                <td scope="col" class="text-xs font-weight-bold text-uppercase mb-1"  style="padding-left: 20px; width: 30%; " >
                                                    <span>
                                                      <input type="date" class="text-xs text-uppercase mb-1 table-cell text-gray-900 form-control " id="paymentDuedate" style="margin-top: 8px; padding: 5px; width: 100%; font-size: 12px" placeholder="SELECT REINSTATEMENT  DATE" required><br>
                                                    </span>
                                                </td>
                                                ...
                                                <td scope="col" class="text-xs font-weight-bold text-uppercase mb-1"  style="padding-left: 20px; width: 30%; " hidden>
                                                    <span>
                                            ...
                                            <tr>
                                                <td scope="col" class="text-xs font-weight-bold text-uppercase mb-1"  style="padding-left: 20px; width: 30%; " colspan="4">
                                                   <button  class="btn btn-primary" style="font-size: 12px; float: right" id="requestIntermentbtn" type="button" >PROCEED</button>
                                                </td>
                                            </tr>
                                            <tr hidden>
    ...
    <script>                        
                  ...
                  targets: [6],
                    ...
                    render: function(data, type, row) {
                        ...
                        if (status === 'Active' || status === 'ACTIVE') {
                            ...
                            backgroundColorClass = 'btn-danger';
                        } else {
       ...
       function populateTable(data) {
           ...
           // Fetch ledger data for a specific account
            function fetchpenaltiesAccount(accountId) {
            $.ajax({
              url: 'FETCH.Validation_reinstatement_penalties.php',
              method: 'POST',
              data: {
                accountId: accountId
              },
              ...
              success: function(response) {
                if (response.length > 0) {
                    ...
                    var formattedpenalty = new Intl.NumberFormat('en-PH', {
                        style: 'currency',
                        currency: 'PHP'
                    }).format(penalty);
                    
                    
                    var formattedpenaltyWithSpace = '₱ ' + formattedpenalty.substring(1);
                    $('#penaltyamount').text(formattedpenaltyWithSpace);
            ...
            function fetchReinstatementAccount(accountId) {
            $.ajax({
              url: 'FETCH.Validation_reinstatement_frequency.php',
              method: 'POST',
              data: {
                accountId: accountId
              },
              ...
              success: function(response) {
                if (response.length > 0) {
                    var data = response[0]; // Retrieve the first item in the response array
                    $('#frequencyrequest').text(data.count);
            ...
            function fetchnoMonthspenalty(accountId) {
            $.ajax({
              url: 'FETCH.Validation_reinstatement_noMonthspenalty.php',
              method: 'POST',
              data: {
                accountId: accountId
              },
              ...
              success: function(response) {
                if (response.length > 0) {
                    var data = response[0]; // Retrieve the first item in the response array
                    $('#noMonthspenalty').text(data.count);
            ...
            $.ajax({
                url: "FETCH.Validation_reinstatement.php", // Replace with your actual server endpoint URL
                method: "POST",
                dataType: "json",
            ...
            function openModal(accountId) {
                ...
                fetchpenaltiesAccount(accountId);
                balanceComputation(accountId);
                fetchReinstatementAccount(accountId);
                fetchnoMonthspenalty(accountId);
            }
   ...
   function removeRow(button) {
    ...
    <script>
      ...
      // Add an event listener to the time input to enable/disable the date input
      timeInput.addEventListener("change", function() {
        // Check if a time is selected
        if (timeInput.value !== "") {
          // If a time is selected, enable the date input and reset other elements
    ...
    <script>
            ...
            var noMonthspenalty = parseInt(document.getElementById("noMonthspenalty").textContent);
            var frequencyrequest = parseInt(document.getElementById("frequencyrequest").textContent);
            var penaltyamountText = document.getElementById("penaltyamount").textContent;
            var numericPart = penaltyamountText.replace(/[^\d.]/g, '');

            // Now, parse the numeric part as a floating-point number
            var penaltyamountrequest = parseFloat(numericPart);
            var daysPenalty = 0;
            var frequencyPenalty = 0;
        
            if (noMonthspenalty <= 30) {
                daysPenalty = 500;
            } else if (noMonthspenalty >= 31 && noMonthspenalty <= 60) {
                daysPenalty = 1000;
            } else if (noMonthspenalty >= 61) {
                daysPenalty = 1500;
            }
        
            if (frequencyrequest === 1 || frequencyrequest === 2) {
                frequencyPenalty = 500;
            } else if (frequencyrequest === 3 || frequencyrequest === 4) {
                frequencyPenalty = 1000;
            } else if (frequencyrequest === 5 || frequencyrequest === 6) {
                frequencyPenalty = 1500;
            } else if (frequencyrequest >= 7) {
                frequencyPenalty = 1500;
            }
        
            // You can now use 'daysPenalty' and 'frequencyPenalty' as needed.
            var totalPenalty = daysPenalty + frequencyPenalty;

           // Calculate the totalReinstatementAmountPaid by adding penaltyamountrequest and totalPenalty
            var totalReinstatementAmountPaid = penaltyamountrequest + totalPenalty;
            
            // Format the totalReinstatementAmountPaid as currency with the peso sign and commas
           var formattedpenalty = totalReinstatementAmountPaid.toLocaleString('en-US', {
                minimumFractionDigits: 2,
                maximumFractionDigits: 2
            });
            
            // Add the peso sign and a space to the formatted currency
            var formattedtotalReinstatementAmountPaidWithSpace = formattedpenalty;
            
            // Set the content of an HTML element with id "amountPaid1" to the formatted currency
            document.getElementById("amountPaid1").textContent = '₱ ' + formattedtotalReinstatementAmountPaidWithSpace;
            // You can perform further calculations or display the total penalty in your application.
            
             var formattedtotalPenalty = totalPenalty.toLocaleString('en-US', {
                minimumFractionDigits: 2,
                maximumFractionDigits: 2
            });
            
            // Add the peso sign and a space to the formatted currency
            var formattedtotalPenaltyWithSpace = formattedtotalPenalty;
            
            // Set the content of an HTML element with id "amountPaid1" to the formatted currency
            document.getElementById("reinstatementfee").textContent = '₱ ' + formattedtotalPenaltyWithSpace;
        }
        function addItem() {
...
<script>
    function updateImage() {
        ...
        var imageUrls = {
            ...
            "picture-name-dates": "https://centennialgarden.ph/SSDCAdmin180231/img/nameandepitaph.png",
            "name-dates-epitaph": "https://centennialgarden.ph/SSDCAdmin180231/img/nameandpicture.png",
        };
...
<script> 
    $(document).ready(function () {
        $('#requestIntermentbtn').click(function () {
            ...
            var noMonthspenalty = $('#noMonthspenalty').text();
            var frequencyrequest = $('#frequencyrequest').text();
            var penaltyamount = $('#penaltyamount').text();
            var reinstatementfee = $('#reinstatementfee').text();
            var amountPaid1 = $('#amountPaid1').text();
            ...
            $.ajax({
                type: 'POST',
                url: 'FETCH.Insert_SalesReinstatement.php',
                data: {
                    noMonthspenalty: noMonthspenalty,
