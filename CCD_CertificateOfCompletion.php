        ...
        <li class="nav-item">
                        ...
                        <div id="collapsePages" class="collapse" aria-labelledby="headingPages"
                            ...
                            <div class="bg-white py-2 collapse-inner rounded">
                                <a class="collapse-item" href="CCD_paymentVerification.php">Verify - Lot</a>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive" style="color:#2F4F4F;">
                                    ...
                                    $sales_query = "SELECT * from tbl_ledger LEFT JOIN buyersinformationsheet  ON tbl_ledger.contractCode =  buyersinformationsheet.contractCode  WHERE tbl_ledger.status1='Purchased';";
                                       ...
                                       <td class="Sex" name="Sex" hidden><?=$row['Sex']?></td> 
                                           ...
                                           <td style="text-align: center;">  
                                              <script>
                                                   ...
                                                   document.getElementById('collectionVAT').value = collectionVAT1;
                                    ...
                                    <div  style="width: 50%; float: right; border-color: #5B7EDE">
                                        <table class="table"   cellspacing="0"   >
                                           ...
                                           <td style="border: none;background-color: #5B7EDE;font-size: 13px;color:white;padding:0px 15px;margin:0px; font-weight: bold;" >
                                            ...
                                            <input readonly placeholder="₱ 0.00" id="MI" name="MI" readonly  pattern="^\₱\d{1,3}(,\d{3})*(\.\d+)?₱" data-type="currency"  style="padding:0px 15px; width: 92%; font-size: 13px; margin:0px; background-color: #e8e4c9 ;border: none;color:#4a4949" ></input>
  ...
  <div class="modal-dialog" role="document">
    ...
    <script>
     ...
     function MA() {
        ...
        document.getElementById("MI").value = "₱ " +  monthlyInstallment1fixed;
...
var user                     = $('#user1').val();
   ...
   var dataTable = $('#userTable').DataTable({
    ...
    function collectionNoOfMonths() {
        let monthlyInstallmentCollection=  document.getElementById("MI").value;
     ...
     function collectionAmountPaid() {
        let monthlyInstallmentCollection12=  document.getElementById("MI").value;
