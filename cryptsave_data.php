...
$unitno = sanitizeInput($_POST["unitno"]);
...
try {
    ...
    $stmt = $conn->prepare("INSERT INTO tbl_cryptdescription (phase, level, area, section, crypt_column, unit_no, classification, listPrice, status) 
                           VALUES (:phase, :level, :area, :section, :column, :unitno, :classification, :listprice, :status)");
